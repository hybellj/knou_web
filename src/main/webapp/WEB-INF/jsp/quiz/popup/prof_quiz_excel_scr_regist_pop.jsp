...
<html lang="ko" style="position: fixed; width: 100%;">
	...
	<script type="text/javascript">
		var excelExampleGrid = {
			colModel:[
				{label:"<spring:message code='common.dept_name' />",			name:'deptnm',	align:'left',	width:'5000',	colums:'A'},/* 학과 */
				{label:"<spring:message code='common.label.student.number' />",	name:'userId',	align:'left',	width:'5000',	colums:'B'},/* 학번 */
				{label:"<spring:message code='common.name' />",					name:'usernm',	align:'left',	width:'5000',	colums:'C'},/* 이름 */
	            {label:"<spring:message code='quiz.label.evl.scr' />",			name:'totScr',	align:'right',	width:'5000',	colums:'D'}/* 평가점수 */
			]
		};
		...
		function quizScrExcelUpload() {
			...
			const url 	= "/quiz/profQuizScrExcelUpload.do";
			const data 	= {
	    ...
	    function saveConfirm() {
	    	let fileUploader = dx5.get("fileUploader");
	    	// 파일이 있으면 업로드 시작

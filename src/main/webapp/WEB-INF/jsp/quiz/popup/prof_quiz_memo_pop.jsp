...
<html lang="ko" style="position: fixed; width: 100%;">
	...
	<script type="text/javascript">
		...
		function profMemoRegist() {
			const url  = "/quiz/quizProfMemoModifyAjax.do";
			const data = {
			...
			$.ajax({
                ...
                success		: function (data) {
                    if (data.result > 0) {
                    	UiComm.showMessage("<spring:message code='quiz.alert.insert.memo' />", "success");	/* 메모 저장이 완료되었습니다. */
                ...
                error		: () => UiComm.showMessage("<spring:message code='quiz.error.memo.insert' />", "error"),	/* 메모 저장 중 에러가 발생하였습니다. */
	...
	<body class="modal-body">
		<div class="board_top class">
            <h3 class="board-title">${vo.sbjctnm } ${vo.dvclasNo }<spring:message code="quiz.label.decls" /><!-- 반 --></h3>
            <div class="right-area">
                <div class="feedback-info">
                    <p class="desc">
                        ...
                        <span class="score"><strong>${quizExamnee.totScr }<spring:message code="message.score" /><!-- 점 --></strong></span>
                    </p>
                </div>
            </div>
        </div>
		...
		<div class="modal_btns">
	        <button class="btn type1" onclick="profMemoRegist()"><spring:message code="common.button.save" /></button><!-- 저장 -->

...
<body class="home colorA "><!-- 컬러선택시 클래스변경 -->
    <div id="wrap" class="main">
        <!-- common header -->
        <%@ include file="../common_new/home_header.jsp" %>
        <!-- //common header -->
        ...
        <main class="common">
            ...
            <!-- gnb -->
            <%@ include file="../common_new/home_gnb_stu.jsp" %>
            <!-- //gnb -->
                                                    ...
                                                    <div class="user-option-wrap">
                                                        ...
                                                        <ul class="user_area">
                                                            ...
                                                            <li>
                                                                <div class="user-info">
                                                                    <div class="user-photo">
                                                                        <img src="/webdocs/assets/img/common/photo_user_sample3.jpg" aria-hidden="true" alt="사진">
                                                                    </div>
                                                                    <div class="user-desc">
                                                                        <p class="name">최남단</p>
                                                                        <p class="subject"><span class="major">[대학원]</span>데이터베이스의 이해와 활용</p>

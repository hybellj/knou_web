...
function setMsgWidget() {
	...
	let subTitle = `
		<nav class="tab-type1">
        <nav class="tab-type1 msg-cat-btns">
			<a href="#_" class="btn current" cat="msgCat1"><span>PUSH</span><small class="msg_num" id="widgetPushCnt">0</small></a>
			<a href="#_" class="btn" cat="msgCat2"><span>SMS</span><small class="msg_num" id="widgetSmsCnt">0</small></a>
			<a href="#_" class="btn" cat="msgCat3"><span><spring:message code='msg.title.msg.shrtnt'/></span><small class="msg_num" id="widgetShrtntCnt">0</small></a>
			<a href="#_" class="btn" cat="msgCat4"><span><spring:message code='msg.title.msg.alimTalk'/></span><small class="msg_num" id="widgetAlimtalkCnt">0</small></a>
		</nav>
		<div class="btn-wrap">

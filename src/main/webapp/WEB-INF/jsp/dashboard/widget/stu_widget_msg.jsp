...
function setMsgWidget() {
	...
	$("#wigt_stu_msg_title").css({"flex-wrap":"nowrap","white-space":"nowrap"});
...
$(document).on('click', '#msgListBox .item_txt[data-sndng-tycd]', function(e) {
	...
	if (sndngTycd === 'SHRTNT') {
		location.href = '/stdntMsgShrtntRcvnSelectView.do?msgShrtntSndngId=' + encodeURIComponent(sndngId);
	}
});
...
function moveMsgWidgetMore() {
	...
	if (activeCat === 'msgCat3') {
		location.href = '/stdntMsgShrtntListView.do';
	}
}

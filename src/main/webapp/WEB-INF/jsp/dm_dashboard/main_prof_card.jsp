...
<body class="home colorA "><!-- 컬러선택시 클래스변경 -->
    <div id="wrap" class="main">
        ...
        <jsp:include page="../dm_inc/home_header.jsp">
            <jsp:param name="userId" value="${dashboardVO.userId}" />
            <jsp:param name="userGbn" value="${dashboardVO.userGbn}" />
      	</jsp:include>
        <!-- //common header -->
        ...
        <main class="common">
            <!-- gnb -->
            <jsp:include page="../dm_inc/home_gnb_prof.jsp">
                  ...
                  <div class="box_content">
                      <div class="today_line">
                          <div class="item today">
                              ...
                              <div class="item_info">2025.12.01</div>
                          </div>
                          <div class="item user">
                              <div class="item_tit">
                                  ...
                                  <div class="alrim_item_area">									
                                      <div class="item_box push">								
                                          <a href="#0" class="item_txt">
                                              ...
                                              <p class="tit">과제 제출 기간이 얼마 남지 않았습니다.</p>
                                          </a>
                                          <div class="state">
                                  ...
                                  <div class="card_item">
                                      <div class="item_header">
                                          <div class="title_area">
                                              ...
                                              <p class="tit">
                                              <a href="/crs/crsHomeProf.do?orgId=${orgId}&menuGbn=COURSE&univGbn=UNIV&menuType=PROFESSOR">데이터베이스의 이해와 활용</a>
                                              </p>                                                        
                                          </div>                                                                                                                                                        
                                      </div>
                                      <div class="extra">
                                  ...
                                  <div class="card_item">
                                      <div class="item_header">
                                          ...
                                          <div class="title_area">                                                        
                                              ...
                                              <p class="tit"><a href="/crs/crsHomeProf.do?orgId=${orgId}&menuGbn=COURSE&univGbn=univ">데이터베이스의 이해와 활용</a></p>                                                        
                                          </div> 
                                          <div class="extra">
                                              <div class="my_prog_rate">
                                                  <span class="prog_num">평균 진도율</span><span class="meta">40%</span>    

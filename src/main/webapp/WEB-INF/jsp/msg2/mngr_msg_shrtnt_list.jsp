...
<script type="text/javascript">
    ...
    function fn_rcvnDetail(msgShrtntSndngId) {
        location.href = '/mngrMsgShrtntRcvnDetailView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgShrtntSndngId: msgShrtntSndngId });
    }

    /* 발신 상세 이동 */
    function fn_sndngDetail(msgId) {
        location.href = '/mngrMsgShrtntSndngDetailView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: msgId });
    }

...
<script type="text/javascript">
    let msgId = '${msgId}';
    let modifyUrl = '${userCtx.admin ? "/mngrMsgShrtntSndngRegistView.do" : "/profMsgShrtntSndngRegistView.do"}';
    ...
    /* 수정 */
    function fn_modify() {
        location.href = modifyUrl + '?msgId=' + encodeURIComponent(msgId);
    }
    ...
    /* 목록으로 */
    function fn_list() {
        location.href = listUrl + '?tab=SNDNG';
    }
</script>

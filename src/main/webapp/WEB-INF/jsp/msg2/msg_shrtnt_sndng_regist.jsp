...
<script type="text/javascript">
    ...
    */
    ...
    /* 목록으로 */
    function fn_list() {
        let listUrl = '${isAdmin ? "/mngrMsgShrtntListView.do?tab=SNDNG" : "/profMsgShrtntListView.do?tab=SNDNG"}';
                    ...
                    <div class="sub-content">
                        ...
                        <div class="table_list">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    <input type="text" id="rsrvSndngDate" name="rsrvSndngDate" class="datepicker" placeholder="<spring:message code="msg.shrtnt.label.sndngDate" text="날짜"/>">
                                    <input type="text" id="rsrvSndngTime" name="rsrvSndngTime" class="timepicker" placeholder="<spring:message code="msg.shrtnt.label.sndngTime" text="시간"/>">

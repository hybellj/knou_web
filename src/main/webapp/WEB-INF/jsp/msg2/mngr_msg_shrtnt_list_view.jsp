...
<script type="text/javascript">
    ...
    function fn_initTable() {
        ...
        if (activeTab === 'RCVN') {
            columns = [
                ...
                {title:"<spring:message code='msg.shrtnt.col.deptnm' text='학과'/>",        field:"deptnm",      headerHozAlign:"center", hozAlign:"center", width:110,  minWidth:60},
                {title:"<spring:message code='msg.shrtnt.col.sbjctnm' text='운영과목'/>",   field:"sbjctnm",     headerHozAlign:"center", hozAlign:"center", width:180,  minWidth:60},
                ...
                {title:"<spring:message code='msg.shrtnt.col.sndngnm' text='발신자'/>",     field:"sndngnm",     headerHozAlign:"center", hozAlign:"center", width:90,  minWidth:50},
                ...
                {title:"<spring:message code='msg.shrtnt.col.rprsId' text='대표ID'/>",      field:"userRprsId2", headerHozAlign:"center", hozAlign:"center", width:120,  minWidth:60},
    ...
    function fn_rcvnDetail(msgShrtntSndngId) {
        location.href = '/mngrMsgShrtntRcvnSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgShrtntSndngId: msgShrtntSndngId });
    }

    /* 발신 상세 이동 */
    function fn_sndngDetail(msgId) {
        location.href = '/mngrMsgShrtntSndngSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: msgId });
    }

    /* 발신하기 이동 */
    function fn_sndngRegist() {
        location.href = '/mngrMsgShrtntSndngRegistView.do?encParams=' + EPARAM;
    }

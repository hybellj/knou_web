...
<script type="text/javascript">
    ...
    function fn_initTable() {
        ...
        $('#emlList_cardForm').html($('#' + cardFormId).html());
    ...
    function fn_loadList(pageIndex) {
        ...
        const url = ACTIVE_TAB === 'RCVN' ? '/msgEmlRcvnListAjax.do' : '/msgEmlSndngListAjax.do';
    ...
    function fn_rcvnDetail(msgEmlSndngId) {
        location.href = '/profMsgEmlRcvnSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgEmlSndngId: msgEmlSndngId });
    }

    function fn_sndngDetail(msgId) {
        location.href = '/profMsgEmlSndngSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: msgId });
    }

    function fn_sndngRegist() {
        location.href = '/profMsgEmlSndngRegistView.do?encParams=' + EPARAM;
    }
        ...
        <div id="content" class="content-wrap common">
            <div class="dashboard_sub">
                ...
                <div class="sub-content">
                    ...
                    <!-- 이메일 카드 폼 -->
                    <div id="emlList_cardForm" style="display:none"></div>
                    ...
                    <div id="sndngCardForm" style="display:none">
                        ...
                        <div class="card-body">
                            ...
                            <div class="etc">
                                <p><label class="label-title"><spring:message code='msg.eml.col.rcvrCnt' text='수신자'/></label><strong>#[rcvrCnt]</strong></p>
                                <p><label class="label-title"><spring:message code='msg.eml.col.sndngYn' text='발신'/></label><strong>#[sndngYn]</strong></p>
                            </div>
                        </div>
                    </div>

...
<script type="text/javascript">
    ...
    function fn_loadRcvrList(pageIndex) {
        ...
        ajaxCall('/admMsgEmlSndngRcvrListAjax.do', param, function(res) {
    ...
    function fn_modify() {
        location.href = '/admMsgEmlSndngModifyView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: MSG_ID });
    }

...
<script type="text/javascript">
    ...
    function fn_loadList(pageIndex) {
        ...
        const url = ACTIVE_TAB === 'RCVN' ? '/msgShrtntRcvnListAjax.do' : '/msgShrtntSndngListAjax.do';
    ...
    function fn_rcvnDetail(msgShrtntSndngId) {
        location.href = '/profMsgShrtntRcvnSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgShrtntSndngId: msgShrtntSndngId });
    }

    function fn_sndngDetail(msgId) {
        location.href = '/profMsgShrtntSndngSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: msgId });
    }

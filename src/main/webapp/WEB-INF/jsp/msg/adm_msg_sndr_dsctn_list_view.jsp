...
<script type="text/javascript">
    ...
    function fn_loadList(pageIndex, callback) {
        ...
        ajaxCall('/admMsgSndrDsctnListAjax.do', param, function(res) {
            if (res.encParams) EPARAM = res.encParams;
            if (res.result > 0) {
    ...
    function fn_loadSmry() {
        ...
        ajaxCall('/admMsgSndrDsctnSmrySelectAjax.do', param, function(res) {
            if (res.encParams) EPARAM = res.encParams;
    ...
    function fn_excelDown() {
        ...
        form.attr("action", "/admMsgSndrDsctnExcelDown.do");
    ...
    function fn_smryExcelDown() {
        ...
        form.attr("method", "POST");
        form.attr("name", "excelForm");
        form.attr("action", "/admMsgSndrDsctnSmryExcelDown.do");
        form.append($('<input/>', { type: 'hidden', name: 'orgId', value: param.orgId }));
        form.append($('<input/>', { type: 'hidden', name: 'sbjctYr', value: param.sbjctYr }));
        form.append($('<input/>', { type: 'hidden', name: 'sbjctSmstr', value: param.sbjctSmstr }));
        form.append($('<input/>', { type: 'hidden', name: 'sbjctId', value: param.sbjctId }));
            ...
            <div id="content" class="content-wrap common">
                <div class="admin_sub">
                    ...
                    <div class="sub-content">
                        ...
                        <!-- 발송내역 -->
                        <div class="board_top">
                            <h3 class="board-title"><spring:message code="msg.sndrDsctn.label.listTitle" text="발송내역"/>
                        ...
                        sndrDsctnTable = UiTable("sndrDsctnList", {
                            ...
                            columns: [
                                ...
                                {title:"<spring:message code='msg.sndrDsctn.col.org' text='기관'/>",         field:"orgnm",      headerHozAlign:"center", hozAlign:"center", width:225,  minWidth:60},

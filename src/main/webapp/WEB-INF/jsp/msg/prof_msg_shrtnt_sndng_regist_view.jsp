...
<script type="text/javascript">
    ...
    function fn_loadSbjctList() {
        ...
        ajaxCall('/msgMgrSbjctListAjax.do', { encParams: EPARAM, addParams: UiComm.makeEncParams(data) }, function(res) {
            if (res.encParams) EPARAM = res.encParams;
            let html = allHtml;
            if (res.result > 0 && res.returnList) {
                res.returnList.forEach(function(v) {
        ...
        <div id="content" class="content-wrap common">
            <div class="dashboard_sub">
                <div class="sub-content">
                    ...
                    <input type="hidden" name="upMsgShrtntSndngId" id="upMsgShrtntSndngId" value=""/>

...
<script type="text/javascript">
    ...
    function fn_save() {
        ...
        UiValidator("msgSndngForm").then(function(result) {
            ...
            if (RCVR_LIST.length === 0) {
                UiComm.showMessage("<spring:message code='msg.push.msg.requiredRcvr'/>", "warning");
                return;
            }

            const confirmMsg = IS_EDIT_MODE ? '<spring:message code="msg.push.msg.confirmModify"/>' : '<spring:message code="msg.push.msg.confirmRegist"/>';
    ...
    function fn_doSave() {
        ...
        const url = IS_EDIT_MODE ? '/msgPushSndngModifyAjax.do' : '/msgPushSndngRegistAjax.do';
    ...
    function fn_list() {
        location.href = '/profMsgPushListView.do?encParams=' + LIST_EPARAM;
    }
</script>
        ...
        <div id="content" class="content-wrap common">
            <div class="dashboard_sub">
                <div class="sub-content">
                    ...
                    <div class="board_top">
                        <h3 class="board-title"><spring:message code="msg.common.label.sndngRegist" text="푸시 발신하기"/></h3>
                    ...
                    <!-- 받는 사람 -->
                    <div class="board_top">
                        <h4 class="sub-title"><spring:message code="msg.push.label.rcvrList" text="받는 사람"/></h4>
                        <div class="right-area">
                        ...
                        <table class="table-type2">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><spring:message code="msg.push.col.mblPhn" text="휴대폰번호"/></th>
                                    <th><spring:message code="msg.common.col.eml" text="이메일"/></th>
                                    <th><spring:message code="msg.push.col.sndngYn" text="발송"/></th>

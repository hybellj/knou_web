...
<script type="text/javascript">
    ...
    function fn_initDetail() {
        $('#sndngDttm').text(UiComm.formatDate('<c:out value="${detail.sndngDttm}"/>', 'datetime2'));
    }
    ...
    function fn_list() {
        location.href = '/stdntMsgShrtntListView.do?encParams=' + EPARAM;
    }
</script>
            ...
            <div class="dashboard_sub">
                ...
                <div class="sub-content">
                    ...
                    <div class="table_list">
                        ...
                        <ul class="list">
                            <li class="head"><label><spring:message code="msg.shrtnt.label.rcvSbjct" text="수강과목"/></label></li>
                            <li><c:choose>
                        ...
                        <ul class="list">
                            ...
                            <li>
                                <div class="tb_content" style="white-space: pre-wrap;"><c:out value="${detail.sndngCts}"/></div>
                            </li>
                        </ul>
                        <ul class="list">
                        ...
                        <ul class="list">
                            ...
                            <li><c:out value="${detail.sndngnm}"/></li>
                        </ul>
                    </div>

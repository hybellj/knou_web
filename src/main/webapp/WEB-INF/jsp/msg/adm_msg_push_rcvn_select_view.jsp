        ...
        <div id="content" class="content-wrap common">
            <div class="admin_sub">
                ...
                <div class="sub-content">
                    ...
                    <div class="board_top">
                        <h3 class="board-title"><spring:message code="msg.push.label.rcvnCtsTitle" text="푸시 수신 내용"/></h3>
                    </div>
                    ...
                    <div class="table_list">
                        ...
                        <ul class="list">
                            ...
                            <li>
                                <div class="tb_content" id="sndngTtl" style="white-space: pre-wrap;"><c:out value="${detail.sndngTtl}"/></div>
                            </li>
                        </ul>
                        <ul class="list">

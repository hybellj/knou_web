...
<script type="text/javascript">
    ...
    function fn_buildRcvrTable() {
        rcvrTable = UiTable("rcvrList", {
            ...
            columns: [
                ...
                {title:"<spring:message code='msg.alimTalk.col.sndngYn' text='발송'/>",      field:"sndngYn",     headerHozAlign:"center", hozAlign:"center", width:70,  minWidth:50, formatter:"html"},
    ...
    function fn_loadRcvrList(pageIndex) {
        ...
        ajaxCall('/msgAlimTalkSndngRcvrListAjax.do', param, function(res) {
    ...
    function fn_modify() {
        location.href = '/profMsgAlimTalkSndngModifyView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: MSG_ID });
    }
    ...
    function fn_list() {
        location.href = '/profMsgAlimTalkListView.do?encParams=' + EPARAM;
    }
</script>
        ...
        <div id="content" class="content-wrap common">
            <div class="dashboard_sub">
                ...
                <div class="sub-content">
                    ...
                    <div class="board_top">
                        <h3 class="board-title"><spring:message code="msg.alimTalk.label.sndngCtsTitle" text="알림톡 발신 내용"/></h3>
        ...
        <div class="modal-body">
            <div class="msg-box">
                <p class="txt">
                    ...
                    <span>
                        <spring:message code="msg.alimTalk.msg.rsrvCnclConfirm" text="알림톡 발송 예약을 취소하시겠습니까?"/><br>

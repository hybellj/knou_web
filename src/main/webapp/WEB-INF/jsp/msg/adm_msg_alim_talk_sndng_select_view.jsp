...
<script type="text/javascript">
    ...
    function fn_loadRcvrList(pageIndex) {
        ...
        ajaxCall('/admMsgAlimTalkSndngRcvrListAjax.do', param, function(res) {
    ...
    function fn_modify() {
        location.href = '/admMsgAlimTalkSndngModifyView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: MSG_ID });
    }
    ...
    function fn_list() {
        location.href = '/admMsgAlimTalkListView.do?encParams=' + EPARAM;
    }
</script>

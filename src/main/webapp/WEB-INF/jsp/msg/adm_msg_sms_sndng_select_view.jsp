...
<script type="text/javascript">
    ...
    function fn_buildRcvrTable() {
        rcvrTable = UiTable("rcvrList", {
            ...
            columns: [
                ...
                {title:"<spring:message code='msg.sms.col.sndngYn' text='발송'/>",      field:"sndngYn",     headerHozAlign:"center", hozAlign:"center", width:70,  minWidth:50, formatter:"html"},
    ...
    function fn_loadRcvrList(pageIndex) {
        ...
        ajaxCall('/admMsgSmsSndngRcvrListAjax.do', param, function(res) {
    ...
    function fn_modify() {
        location.href = '/admMsgSmsSndngModifyView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: MSG_ID });
    }
        ...
        <div id="content" class="content-wrap common">
            <div class="admin_sub">
                ...
                <div class="sub-content">
                    ...
                    <div class="board_top">
                        <h3 class="board-title"><spring:message code="msg.sms.label.sndngCtsTitle" text="문자 발신 내용"/></h3>
                    ...
                    <div class="table_list">
                        ...
                        <c:if test="${not empty detail.ttl}">
                        <ul class="list">
        ...
        <div class="modal-body">
            <div class="msg-box">
                <p class="txt">
                    ...
                    <span>
                        <spring:message code="msg.sms.msg.rsrvCnclConfirm" text="문자 발송 예약을 취소하시겠습니까?"/><br>

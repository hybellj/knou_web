...
<script type="text/javascript">
    ...
    function fn_loadRcvrList(pageIndex) {
        ...
        ajaxCall('/msgPushSndngRcvrListAjax.do', param, function(res) {
    ...
    function fn_modify() {
        location.href = '/profMsgPushSndngModifyView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: MSG_ID });
    }
    ...
    function fn_list() {
        location.href = '/profMsgPushListView.do?encParams=' + EPARAM;
    }
</script>

...
<script type="text/javascript">
    ...
    function fn_loadList(pageIndex) {
        ...
        const url = ACTIVE_TAB === 'RCVN' ? '/admMsgPushRcvnListAjax.do' : '/admMsgPushSndngListAjax.do';
    ...
    function fn_rcvnDetail(msgMblSndngId) {
        location.href = '/admMsgPushRcvnSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgMblSndngId: msgMblSndngId });
    }

    function fn_sndngDetail(msgId) {
        location.href = '/admMsgPushSndngSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: msgId });
    }

    function fn_sndngRegist() {
        location.href = '/admMsgPushSndngRegistView.do?encParams=' + EPARAM;
    }
    ...
    function fn_pushDeleteSequential(ids, idField, index, state) {
        ...
        ajaxCall('/admMsgPushDeleteAjax.do',
    ...
    function fn_doRsrvCncl() {
        ...
        ajaxCall('/admMsgPushRsrvCnclModifyAjax.do', param, function(res) {
            if (res.encParams) EPARAM = res.encParams;
            if (res.result > 0) {

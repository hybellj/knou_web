...
<script type="text/javascript">
    ...
    function fn_buildRcvrTable() {
        rcvrTable = UiTable("rcvrList", {
            ...
            columns: [
                ...
                {title:"<spring:message code='msg.push.col.sndngYn' text='발송'/>",      field:"sndngYn",     headerHozAlign:"center", hozAlign:"center", width:70,  minWidth:50, formatter:"html"},
    ...
    function fn_loadRcvrList(pageIndex) {
        ...
        ajaxCall('/admMsgPushSndngRcvrListAjax.do', param, function(res) {
    ...
    function fn_modify() {
        location.href = '/admMsgPushSndngModifyView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: MSG_ID });
    }
    ...
    function fn_list() {
        location.href = '/admMsgPushListView.do?encParams=' + EPARAM;
    }
</script>
        ...
        <div id="content" class="content-wrap common">
            <div class="admin_sub">
                ...
                <div class="sub-content">
                    ...
                    <div class="board_top">
                        <h3 class="board-title"><spring:message code="msg.push.label.sndngCtsTitle" text="푸시 발신 내용"/></h3>
                    ...
                    <div class="table_list">
                        ...
                        <ul class="list">
                            ...
                            <li>
                                <div class="tb_content" id="detailTtl" style="white-space: pre-wrap;"><c:out value="${detail.ttl}"/></div>
                            </li>
                        </ul>
                        <ul class="list">
                        ...
                        <ul class="list">
                            ...
                            <li id="sndngPhnno"><c:out value="${detail.sndngPhnno}"/></li>
                        </ul>
                    </div>
        ...
        <div class="modal-body">
            <div class="msg-box">
                <p class="txt">
                    ...
                    <span>
                        <spring:message code="msg.push.msg.rsrvCnclConfirm" text="푸시 발송 예약을 취소하시겠습니까?"/><br>

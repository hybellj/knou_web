...
<script type="text/javascript">
    ...
    function fn_save() {
        ...
        UiValidator("msgSndngForm").then(function(result) {
            ...
            UiComm.showMessage('<spring:message code="msg.alimTalk.msg.confirmRegist"/>', 'confirm').then(function(ok) {
                if (!ok) return;
                fn_doSave();
            });
        });
    ...
    function fn_doSave() {
        ...
        const url = '/msgAlimTalkSndngRegistAjax.do';
    ...
    function fn_list() {
        location.href = '/profMsgAlimTalkListView.do?encParams=' + LIST_EPARAM;
    }
</script>

...
<script type="text/javascript">
    ...
    function fn_loadList(pageIndex) {
        ...
        const url = ACTIVE_TAB === 'RCVN' ? '/msgAlimTalkRcvnListAjax.do' : '/msgAlimTalkSndngListAjax.do';
    ...
    function fn_rcvnDetail(msgMblSndngId) {
        location.href = '/profMsgAlimTalkRcvnSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgMblSndngId: msgMblSndngId });
    }

    function fn_sndngDetail(msgId) {
        location.href = '/profMsgAlimTalkSndngSelectView.do?encParams=' + EPARAM + '&addParams=' + UiComm.makeEncParams({ msgId: msgId });
    }

    function fn_sndngRegist() {
        location.href = '/profMsgAlimTalkSndngRegistView.do?encParams=' + EPARAM;
    }
    ...
    function fn_doRsrvCncl() {
        ...
        ajaxCall('/msgAlimTalkRsrvCnclModifyAjax.do', param, function(res) {
            if (res.encParams) EPARAM = res.encParams;
            if (res.result > 0) {
                ...
                <div class="sub-content">
                    ...
                    <div id="sndngCardForm" style="display:none">
                        ...
                        <div class="card-body">
                            ...
                            <div class="etc">
                                <p><label class="label-title"><spring:message code='msg.alimTalk.col.rcvrCnt' text='수신자'/></label><strong>#[rcvrCnt]</strong></p>
                                <p><label class="label-title"><spring:message code='msg.alimTalk.col.sndngYn' text='발신'/></label><strong>#[sndngYn]</strong></p>
                            </div>
                        </div>
                    </div>

...
<script type="text/javascript">
    ...
    function fn_save() {
        ...
        UiValidator("msgSndngForm").then(function(result) {
            ...
            const confirmMsg = IS_EDIT_MODE ? '<spring:message code="msg.sms.msg.confirmModify"/>' : '<spring:message code="msg.sms.msg.confirmRegist"/>';
    ...
    function fn_doSave() {
        ...
        const url = IS_EDIT_MODE ? '/admMsgSmsSndngModifyAjax.do' : '/admMsgSmsSndngRegistAjax.do';
        ...
        <div id="content" class="content-wrap common">
            <div class="admin_sub">
                <div class="sub-content">
                    ...
                    <input type="hidden" name="mblSndngTycd" id="mblSndngTycd" value="<c:out value='${ed.mblSndngTycd}'/>"/>
                        ...
                        <table class="table-type5">
                            ...
                            <tbody>
                                ...
                                <tr id="ttlRow" style="display:none;">
                                    ...
                                    <td>
                                        <div class="form-row">
                                            <input type="text" id="ttl" name="ttl" class="form-control width-100per" placeholder="<spring:message code="msg.common.label.ttl"/>" inputmask="length" maxLen="200" value="<c:out value='${ed.ttl}'/>" disabled>
                                        </div>
                                    </td>
                                </tr>
                                <tr>

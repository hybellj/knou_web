...
<script type="text/javascript">
    ...
    function fn_doSave() {
        ...
        const url = '/msgEmlSndngRegistAjax.do';
        ...
        <div id="content" class="content-wrap common">
            <div class="dashboard_sub">
                <div class="sub-content">
                    ...
                    <div class="board_top">
                        <h3 class="board-title"><spring:message code="msg.common.label.sndngRegist" text="이메일 발신하기"/></h3>
                    ...
                    <input type="hidden" name="bfrMsgEmlSndngId" id="bfrMsgEmlSndngId" value=""/>

...
<script type="text/javascript">
    ...
    let RCVR_LIST = [{
        ...
        mblPhn:  '<c:out value="${replyInfo.original.sndngrPhnno}"/>',
        eml: ''
    }];
    ...
    function fn_save() {
        ...
        UiValidator("msgSndngForm").then(function(result) {
            ...
            if (!isRsrv) {
                ...
                UiComm.showMessage('<spring:message code="msg.shrtnt.msg.confirmRegist"/>', 'confirm').then(function(ok) {
                    if (!ok) return;
        ...
        ajaxCall('/msgShrtntRcptnRjctCntSelectAjax.do', param, function(res) {
            ...
            if (res.result > 0) {
                ...
                if (rejectedCnt > 0) {
                    ...
                    confirmMsg = '<spring:message code="msg.shrtnt.msg.confirmRegist"/>';
                }
    ...
    function fn_doSave() {
        ...
        const url = '/msgShrtntSndngRegistAjax.do';
        ...
        <div id="content" class="content-wrap common">
            <div class="dashboard_sub">
                <div class="sub-content">
                    ...
                    <input type="hidden" name="upMsgShrtntSndngId" id="upMsgShrtntSndngId" value="<c:out value='${replyMsgShrtntSndngId}'/>"/>
                        ...
                        <table class="table-type5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-row">
                                            <input type="text" id="ttl" name="ttl" class="form-control width-100per" placeholder="<spring:message code="msg.common.label.ttl"/>" inputmask="length" maxLen="200" required="true">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <table class="table-type2">
                            ...
                            <tbody id="rcvrTbody">
                                <tr>
                                    ...
                                    <td data-th="휴대폰번호" class="txt-center"><c:out value="${replyInfo.original.sndngrPhnno}"/></td>
                                    <td data-th="이메일" class="txt-center"></td>

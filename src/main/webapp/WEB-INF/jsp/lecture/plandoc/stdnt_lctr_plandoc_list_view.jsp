            ...
            <div class="dashboard_sub">
                <div class="sub-content">
                    ...
                    <div class="search-typeA">
                        ...
                        <div class="item">
                            <span class="item_tit"><label for="selectCourse">수강과목</label></span>
                            <div class="itemList">
...
<script type="text/javascript">
    ...
    function listPaging(pageIndex) {
        ...
        const url = "/lctr/plandoc/stdntLctrPlandocListAjax.do";
    ...
    function viewPlandoc(sbjctId) {
        ...
        // 상세 페이지로 이동
        location.href = "/lctr/plandoc/stdntLctrPlandocView.do?encParams=" + EPARAM + "&addParams=" + UiComm.makeEncParams(extData);
    }
    ...
    function loadSbjctList() {
        ...
        ajaxCall(url, param, function (data) {
            if (data.result > 0) {
                let html = "";
                html += "<option value=''>수강과목 선택</option>";

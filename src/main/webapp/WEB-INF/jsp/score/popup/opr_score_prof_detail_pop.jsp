...
<body class="modal-page <%=SessionInfo.getThemeMode(request)%>">
	...
	<div id="wrap">
            ...
            <table class="tBasic table-layout-fixed word-break-keep-all mt10 "> 
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="tc" rowspan="2"><c:out value="${oprScoreProfVO.score01}" /></td>
                    </tr>
                    <tr>                            
                    ...
                    <tr>
                        ...
                        <td class="tc"><span class="fcRed">-0.2</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score02}" /></td>
                    </tr>
                    <tr>
                        ...
                        <td class="tc" rowspan="2"><c:out value="${oprScoreProfVO.score03}" /></td>
                    </tr>
                    <tr>                            
                    ...
                    <tr>
                        ...
                        <td class="tc"><span class="fcRed">-0.2</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score04}" /></td>
                    </tr>
                    <tr>
                        ...
                        <td class="tc"><span class="fcBlue">+0.1</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score05}" /></td>
                    </tr>
					<tr>
                        ...
                        <td class="tc"><span class="fcRed">-0.2</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score06}" /></td>
                    </tr>
                    <tr>
                        ...
                        <td class="tc"><span class="fcRed">-0.2</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score07}" /></td>
                    </tr>
                    <tr>
                        ...
                        <td rowspan="4"><spring:message code="score.label.prof.oper.criteria2.alarm" /><!-- 강의실 발송 : 1건당 --></td>
                        <td class="tc"><span class="fcBlue">+0.1</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score08}" /></td>
                    </tr>
                    <tr>
                        <td class="tc"><spring:message code="score.label.prof.oper.criteria2.sub6.sub2" /><!-- SMS발송 --></td>
                        <td class="tc"><span class="fcBlue">+0.1</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score09}" /></td>
                    </tr>
                    <tr>
                        <td class="tc"><spring:message code="score.label.prof.oper.criteria2.sub6.sub3" /><!-- PUSH발송 --></td>
                        <td class="tc"><span class="fcBlue">+0.1</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score10}" /></td>
                    </tr>
                    <tr>
                        <td class="tc"><spring:message code="score.label.prof.oper.score14" /><!-- 쪽지발송 --></td>
                        <td class="tc"><span class="fcBlue">+0.1</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score14}" /></td>
                    </tr>
                    <tr>
                        ...
                        <td class="tc"><span class="fcRed">-0.1</span></td>
                        <td class="tc" rowspan="2"><c:out value="${oprScoreProfVO.score11}" /></td>
                    </tr>
                    <tr>                            
                    ...
                    <tr>
                        ...
                        <td class="tc"><span class="fcBlue">+0.2</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score12}" /></td>
                    </tr>
                    <tr>
                        ...
                        <td class="tc"><span class="fcRed">-0.2</span></td>
                        <td class="tc"><c:out value="${oprScoreProfVO.score13}" /></td>
                    </tr>
                    <tr>
                    	<td class="tc" colspan="5"><spring:message code="message.total" /><!-- 합계 --></td>
                    	<td class="tc"><span id="totScoreText"><c:out value="${oprScoreProfVO.totScore}" /></span></td>
                    </tr>
                </tbody>
            </table>
        </div>
		...
		<div class="bottom-content tr">
			<button type="button" class="ui black cancel button" onclick="window.parent.closeprofDetailModal();"><spring:message code="common.button.close" /><!-- 닫기 --></button>
		</div>
	</div>

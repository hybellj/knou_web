...
<script type="text/javascript">
	...
	function list() {
		if(!$("#lsnOdr").val()) {
			alert('<spring:message code="score.alert.select.lsn.odr" />'); // 주차를 선택하세요.
			return;
		}
		
		var url = "/score/scoreMgr/listOprScoreProfWrite.do";
		var param = {
			  haksaYear		: $("#haksaYear").val()
			, haksaTerm		: $("#haksaTerm").val()
			, lsnOdr		: $("#lsnOdr").val()
		...
		ajaxCall(url, param, function(data) {
			if(data.result > 0) {
				...
				returnList.forEach(function(v, i) {
					...
					html += '	<td><input type="text" class="tr" id="score10_' + v.lineNo + '" name="score10" oninput="this.value=scoreCommon.floatFormat(this.value, true, true, 3, 1)" onblur="scoreCommon.normalizeFloat(this); checkValidScore(this); sumTotScore(\'' + v.lineNo + '\'); autoCheck(\'' + v.lineNo + '\');" onfocus="this.select()" value="' + v.score10 + '" /></td>';
					html += '	<td><input type="text" class="tr" id="score14_' + v.lineNo + '" name="score14" oninput="this.value=scoreCommon.floatFormat(this.value, true, true, 3, 1)" onblur="scoreCommon.normalizeFloat(this); checkValidScore(this); sumTotScore(\'' + v.lineNo + '\'); autoCheck(\'' + v.lineNo + '\');" onfocus="this.select()" value="' + v.score14 + '" /></td>';
					html += '	<td><input type="text" class="tr" id="score11_' + v.lineNo + '" name="score11" oninput="this.value=scoreCommon.floatFormat(this.value, true, true, 3, 1)" onblur="scoreCommon.normalizeFloat(this); checkValidScore(this); sumTotScore(\'' + v.lineNo + '\'); autoCheck(\'' + v.lineNo + '\');" onfocus="this.select()" value="' + v.score11 + '" /></td>';
					html += '	<td><input type="text" class="tr" id="score12_' + v.lineNo + '" name="score12" oninput="this.value=scoreCommon.floatFormat(this.value, true, true, 3, 1)" onblur="scoreCommon.normalizeFloat(this); checkValidScore(this); sumTotScore(\'' + v.lineNo + '\'); autoCheck(\'' + v.lineNo + '\');" onfocus="this.select()" value="' + v.score12 + '" /></td>';
					html += '	<td><input type="text" class="tr" id="score13_' + v.lineNo + '" name="score13" oninput="this.value=scoreCommon.floatFormat(this.value, true, true, 3, 1)" onblur="scoreCommon.normalizeFloat(this); checkValidScore(this); sumTotScore(\'' + v.lineNo + '\'); autoCheck(\'' + v.lineNo + '\');" onfocus="this.select()" value="' + v.score13 + '" /></td>';
	...
	// 교수 수업운영 평가기준 모달
	function profOperateEvalCriteriaModal() {
		$("#oprProfCriteriaForm").attr("target", "oprProfCriteriaIfm");
        $("#oprProfCriteriaForm").attr("action", "/score/scoreMgr/oprScoreProfCriteriaPop.do");
        $("#oprProfCriteriaForm").submit();
        $('#oprProfCriteriaModal').modal('show');
	}
    ...
    function receiveMessage(event) {
 	...
 	function saveScore() {
 		...
 		$.each($("#operateScoreTable").find("input:checkbox[name=userIds]:not(:disabled):checked"), function() {
			...
			var score10 = $("#score10_" + lineNo).val();
			var score11 = $("#score11_" + lineNo).val();
			var score12 = $("#score12_" + lineNo).val();
			var score13 = $("#score13_" + lineNo).val();
			var score14 = $("#score14_" + lineNo).val();
	...
	function deleteScore() {
		var dataList = [];
 		...
 		var url = "/score/scoreMgr/deleteOprScoreProf.do";
		var data = JSON.stringify(dataList);
	...
	function sumTotScore(lineNo) {
		...
		var score10 = 1 * $("#score10_" + lineNo).val();
		var score11 = 1 * $("#score11_" + lineNo).val();
		var score12 = 1 * $("#score12_" + lineNo).val();
		var score13 = 1 * $("#score13_" + lineNo).val();
		var score14 = 1 * $("#score14_" + lineNo).val();
	...
	function autoCheck(lineNo) {
		...
		|| 1 * originObj.score10 != 1 * $("#score10_" + lineNo).val()
		|| 1 * originObj.score11 != 1 * $("#score11_" + lineNo).val()
		|| 1 * originObj.score12 != 1 * $("#score12_" + lineNo).val()
		|| 1 * originObj.score13 != 1 * $("#score13_" + lineNo).val()
		|| 1 * originObj.score14 != 1 * $("#score14_" + lineNo).val();
	...
	function downExcel() {
		...
		var url  = "/score/scoreMgr/downExcelOprScoreProfWrite.do";
		var form = $("<form></form>");
...
<body>
            ...
            <div class="content">
                <div id="info-item-box">
                	<h2 class="page-title flex-item">
					    ...
					    <div class="ui breadcrumb small">
					        <small class="section"><spring:message code='score.label.prof.write' /><!-- 수업운영 점수등록(교수) --></small>
					    </div>
					</h2>
				</div>
				...
				<div class="ui form">
					...
					<div class="ui segment searchArea">
	   				...
	   				<div class="option-content gap4">
	   					<h3 class="sec_head"><spring:message code='score.label.prof.write' /><!-- 수업운영 점수등록(교수) --></h3>
	   					...
	   					<div class="mla">
	   						...
	   						<a class="ui basic button" href="javascript:profOperateEvalCriteriaModal()"><spring:message code="score.button.prof.oper.criteria.table" /><!-- 교수 수업운영 평가기준 안내표 --></a>
	   						...
	   						<a class="ui green button" href="javascript:downExcel()"><spring:message code="common.button.excel_down" /><!-- 엑셀 다운로드 --></a>
	   					</div>
	   				</div>
	   					...
	   					<table class="tBasic" data-empty="<spring:message code='common.content.not_found' />" id="operateScoreTable"><!-- 등록된 내용이 없습니다. -->
		  					<thead class="sticky top0">
			    				<tr>
			    					...
			    					<th class="tc" rowspan="2"><div class="w80"><spring:message code="score.label.rep.professor" /> <spring:message code="score.label.hr.no" /><!-- 인사번호 --></div></th>
			    					<th class="tc" rowspan="2"><spring:message code="common.professor" /><!-- 교수 --></th>
			    					<th class="tc" colspan="14"><spring:message code="score.label.prof.oper.score" /><!-- 수업운영점수 --></th>
			    				</tr>
			    				<tr>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score01" /><!-- 수업계획서 입력기간 준수 --><a href="javascript:sortTable('score01')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score02" /><!-- 종합성적 산출기간 준수 --><a href="javascript:sortTable('score02')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score03" /><!-- 평가기준활용 --><a href="javascript:sortTable('score03')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score04" /><!-- 평가기준정정 --><a href="javascript:sortTable('score04')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score05" /><!-- 공지사항 --><a href="javascript:sortTable('score05')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score06" /><!-- 강의Q&A --><a href="javascript:sortTable('score06')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score07" /><!-- 1:1상담 --><a href="javascript:sortTable('score07')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score08" /><!-- 메일발송 --><a href="javascript:sortTable('score08')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score09" /><!-- SMS발송 --><a href="javascript:sortTable('score09')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score10" /><!-- PUSH발송 --><a href="javascript:sortTable('score10')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score14" /><!-- 쪽지발송 --><a href="javascript:sortTable('score14')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score11" /><!-- 중간/기말 시험출제 및 검수일 준수 --><a href="javascript:sortTable('score11')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score12" /><!-- 시험배수출제 --><a href="javascript:sortTable('score12')"><i class="fooicon fooicon-sort"></i></a></div></th>
			    					<th class="tc"><div class="w100"><spring:message code="score.label.prof.oper.score13" /><!-- 시험중복출제 --><a href="javascript:sortTable('score13')"><i class="fooicon fooicon-sort"></i></a></div></th>
    ...
    <!-- 교수 수업운영 평가기준 팝업 -->
    <form id="oprProfCriteriaForm" name="oprProfCriteriaForm">
	</form>
    <div class="modal fade in" id="oprProfCriteriaModal" tabindex="-1" role="dialog" aria-labelledby="<spring:message code="common.modal.field" />" aria-hidden="false" style="display: none; padding-right: 17px;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="" width="100%" id="oprProfCriteriaIfm" name="oprProfCriteriaIfm"></iframe>
                </div>
            </div>
        </div>
    </div>

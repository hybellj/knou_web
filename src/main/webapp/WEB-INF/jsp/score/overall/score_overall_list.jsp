...
<script type="text/javascript">
	...
	*/
        ...
        //<input type="text" name="list[0].middleTestInput" class="inScore " value="75" placeholder="0" maxlength="5" onkeyup="scoreValidation(this)">
    ...
    function onOpenYn(obj) {
        ...
        ajaxCall("/score/scoreOverall/updateOverallScoreOpenYn.do", {openYn: $(obj).val()}, function (data) {
            if (data.result > 0) {
                /* 처리가 되었습니다. */
    ...
    function onScoreCal() {
        ...
        ajaxCall(url, param, function (data) {
            if (data.result > 0) {
                $("#modalScoreCalForm > input[name=crsCreCd]").val($("#sCrsCreCd").val());
                var returnVO = data.returnVO;
    ...
    function onSearch(searchType) {
        ...
        ajaxCall(url, param, function (data) {
            if (data.result > 0) {
                ...
                html += "<table class='table sticky' data-sorting='true' data-paging='false' data-empty='<spring:message code='exam.common.empty' />'>";
                html += "<thead>";
                html += "	<tr>";
                ...
                html += "        <th class='tc'><spring:message code='common.label.production' /><br class='desktop-elem'><spring:message code='common.label.total.point' /></th>";	// 산출총점
                html += "        <th class='tc'><spring:message code='common.label.exchange' /><br class='desktop-elem'><spring:message code='common.label.total.point' /></th>";	// 환산총점
                html += "        <th name='etcDataTd' class='tc' data-type='number'><spring:message code='common.label.total.include.point' /></th>";	// 가산점
                html += "        <th class='tc' data-type='number'><spring:message code='common.label.final' /><br class='desktop-elem'><spring:message code='common.score' /></th>";	// 최종점수
                ...
                $.each(ratioArr, function (i, o) {
                    ...
                    if (o == "middleTestScore") {
                        selectHtml += "<option value='2'>중간고사</option>";
                    } else if (o == "lastTestScore") {
                        selectHtml += "<option value='3'>기말고사</option>";
                    } else if (o == "testScore") {
                        selectHtml += "<option value='4'>수시평가</option>";
                    } else if (o == "lessonScore") {
                        selectHtml += "<option value='1'>출석/강의</option>";
                    } else if (o == "assignmentScore") {
                        selectHtml += "<option value='5'>과제</option>";
                    } else if (o == "forumScore") {
                        selectHtml += "<option value='6'>토론</option>";
                    } else if (o == "quizScore") {
                        selectHtml += "<option value='7'>퀴즈</option>";
                    } else if (o == "reshScore") {
                        selectHtml += "<option value='8'>설문</option>";
                    }
                });
    ...
    function initSet(status) {
        ...
        interval = setInterval(function () {
            if ($("#scoreStatus").val() == "2" && $("input[name*=dataChk]:checked").length > 0 && "${scoreOverAllYn}" == "1") {
                onSave();
            }
        }, 600000);
    }
    ...
    function sendMsg() {
        if ($("#tableForm").find("input[name*=dataChk]:checked").length == 0) {
            /* 체크된 값이 없습니다. */
            alert('<spring:message code="score.label.after.score" />');
            return;
        }
        var rcvUserInfoStr = "";
    ...
    function getPoorScoreStdList(crsCreCd) {
        var deferred = $.Deferred();

        var url = "/score/scoreOverall/selectOverallPoorScoreStdList.do";
        var param = {
            crsCreCd: crsCreCd
        };
                    ...
                    <div id="info-item-box">
                        <script>
                            $(document).ready(function () {
                                // set location 종합성적 성적
                                setLocationBar("<spring:message code='score.label.university.score' />", "<spring:message code='exam.label.grade' />");
                            });
                        </script>

                        <h2 class="page-title flex-item flex-wrap gap4 columngap16 mra">
                            <spring:message code="score.label.score.proc" /><!-- 성적처리 -->
                        </h2>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="option-content gap4 ">
                                ...
                                <div class="flex flex-wrap gap4 mla">
                                    <c:if test="${TUT_YN ne 'Y' }">
                                        <!-- <a class="ui basic small button" onclick="saveTestScore()">Erp Test 전송</a> -->
                            ...
                            <div class="option-content gap4 mt10 mb10">
                                ...
                                <div class="mla flex">
                                    <button type="button"
                                            class="ui button basic p5 m0 inline-flex-item pl10 pr10 red mr5" id="btnF">
                                        <span class="d-inline-block" style="height: 26px;"></span>F <spring:message
                                            code="score.button.concern"/> [<span id="fCnt">0</span><spring:message
                                    ...
                                    <div class="ui flowing popup left center transition hidden" id="popupF">
                                        <div class="w400">
                                            <div class="ui pointing secondary tabmenu menu mb10" id="tabPopupF">
                                                <a class="item f100 p10 active flex1" id="popupFTab1" data-tab="fcont1"
                                                   style="max-width: 200px;"><i
                                                        class="icon circle info fcBlue opacity7 mr5"></i>
                                                    <spring:message code="score.label.concern.f.msg1" /><!-- F처리 고려 대상 조회 -->
                                                </a>
                                    ...
                                    <small class="inline-flex-item">
                                        [ <spring:message code="exam.label.stare.user.cnt"/><span
                                            id="listTotCnt"></span> <spring:message code="forum.label.person"/>]
                                        <!-- 대상인원 명 -->
                                        [ <spring:message code="score.label.total.person"/><span id="totCnt"></span>
                                        <spring:message code="forum.label.person"/>]<!-- 전체인원 명 -->
                                    </small>
                                </div>
                            </div>
                            ...
                            <form:form id="tableForm" commandName="list">
                                ...
                                <input type="hidden" name="crsCreCd" value="<c:out value="${sCrsCreCd}" />"/>
                                <!--
                                환산전 step bcGreenAlpha10 ,
                                환산중 step bcBlueAlpha10,
                                환산완료 step bcdark1Alpha10
                                -->
                                <div id="tableDiv"
                                        ...
                                        <div class="ui stackable grid mt0 mb0 p_w100">
                                            ...
                                            <div class="six wide column pt0">
                                                <table class="grid-table type2" id="graphTable">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td data-label="<spring:message code="message.marks" />">100
                                                        </td><!-- 배점 -->
...
<form class="ui form" id="modalScoreCalForm" name="modalScoreCalForm" method="POST" action="">
    ...
    <div class="modal fade" id="modalScoreCal" tabindex="-1" role="dialog" aria-labelledby="모달영역" aria-hidden="false">

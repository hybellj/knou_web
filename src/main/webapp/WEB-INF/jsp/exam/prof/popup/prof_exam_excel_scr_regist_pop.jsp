...
<script type="text/javascript">
    ...
    function quizScrExcelUpload() {
        ...
        const url 	= "/quiz/profQuizScrExcelUpload.do";    /* 등록 로직 자체는 퀴즈와 동일하기에.. */
        const data 	= {
...
<div class="board_top">
    <button class="btn basic" onclick="sampleExcelDown()"><spring:message code="exam.button.excel.sample.down" /></button><!-- 엑셀 샘플 다운로드 -->
</div>

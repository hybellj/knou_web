...
<body class="class colorA "><!-- 컬러선택시 클래스변경 -->
	<div id="wrap" class="main">
        ...
        <main class="common">
            ...
            <jsp:include page="../dm_inc/class_gnb_prof.jsp">
                                ...
                                <li class="active"><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.03.04 ~ 2025.03.09</strong></span>
                                        ...
                                        <div class="btn_right">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="optionWrap option-wrap">
                                                    ...
                                                    <div class="item"><a href="#0">차시 추가</a></div>
                                                </div>
                                            </div>	
                                        </div>                                                                    
                                    </div>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.03.10 ~ 2025.03.16</strong></span>
                                                <span>출석<strong>35</strong></span>
                                                <span>지각<strong>3</strong></span>
                                                <span>결석<strong>2</strong></span>
                                            </p>
                                    ...
                                    <div class="cont">                                        
                                        ...
                                        <div class="lecture_box">
                                            ...
                                            <div class="btn_right mr">
                                                <div class="desc_info">
                                                    <span>참여<strong>19</strong></span>
                                                    <span>미참여<strong>1</strong></span>
                                                </div>
                                                <button class="btn s_basic set">토론관리</button>                                                
                                            </div>
                                        </div>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.03.17 ~ 2025.03.23</strong></span>
                                                <span>출석<strong>35</strong></span>
                                                <span>지각<strong>3</strong></span>
                                                <span>결석<strong>2</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.03.24 ~ 2025.03.30</strong></span>
                                                <span>출석<strong>35</strong></span>
                                                <span>지각<strong>3</strong></span>
                                                <span>결석<strong>2</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.03.30 ~ 2025.04.06</strong></span>
                                                <span>출석<strong>35</strong></span>
                                                <span>지각<strong>3</strong></span>
                                                <span>결석<strong>2</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.04.07 ~ 2025.04.13</strong></span>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.04.14 ~ 2025.04.20</strong></span>
                                                <span>출석<strong>-</strong></span>
                                                <span>지각<strong>-</strong></span>
                                                <span>결석<strong>-</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.04.21 ~ 2025.04.27</strong></span>
                                                <span>출석<strong>-</strong></span>
                                                <span>지각<strong>-</strong></span>
                                                <span>결석<strong>-</strong></span>
                                            </p>
                                        ...
                                        <div class="btn_right">
                                            <button class="btn s_type1">결시신청 현황</button>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.04.28 ~ 2025.05.04</strong></span>
                                                <span>출석<strong>35</strong></span>
                                                <span>지각<strong>3</strong></span>
                                                <span>결석<strong>2</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.05.07 ~ 2025.05.11</strong></span>
                                                <span>출석<strong>-</strong></span>
                                                <span>지각<strong>-</strong></span>
                                                <span>결석<strong>-</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.05.12 ~ 2025.05.18</strong></span>
                                                <span>출석<strong>-</strong></span>
                                                <span>지각<strong>-</strong></span>
                                                <span>결석<strong>-</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.05.19 ~ 2025.05.25</strong></span>
                                                <span>출석<strong>-</strong></span>
                                                <span>지각<strong>-</strong></span>
                                                <span>결석<strong>-</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.05.26 ~ 2025.06.01</strong></span>
                                                <span>출석<strong>-</strong></span>
                                                <span>지각<strong>-</strong></span>
                                                <span>결석<strong>-</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.06.02 ~ 2025.06.08</strong></span>
                                                <span>출석<strong>-</strong></span>
                                                <span>지각<strong>-</strong></span>
                                                <span>결석<strong>-</strong></span>
                                            </p>
                                ...
                                <li class=""><!-- 클릭시 active 추가 -->
                                    <div class="title-wrap"> 
                                        <a class="title" href="#">
                                            ...
                                            <p class="desc">
                                                <span>학습기간<strong>2025.06.09 ~ 2025.06.15</strong></span>
                                                <span>출석<strong>-</strong></span>
                                                <span>지각<strong>-</strong></span>
                                                <span>결석<strong>-</strong></span>
                                            </p>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
    		$userConnList = $(".user_area > li"); // 접속현황 목록
    	});
	
	
		// 접속현황 목록 정렬
		function sortUserConnList(sortKey, btn) {
			...
			// 아이콘 토글 반영
		    const icon = $(btn).find(".sort");
		    if (direction == "ASC") {
		        icon.removeClass("xi-long-arrow-down").addClass("xi-long-arrow-up");
		    } else {
		        icon.removeClass("xi-long-arrow-up").addClass("xi-long-arrow-down");
		    }

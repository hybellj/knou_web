	...
	<script type="text/javascript">
		...
		function createListHTML(list) {
			...
			list.forEach(function(v,i) {
				...
				// 강의평가관리
				let manage  = "<a href='javascript:lctrEvlMngPopup(\"" + v.srvyId + "\")' class='btn basic small'><spring:message code='srvy.button.lctr.evl.popup' /></a>";/* 강의평가 팝업관리 */
					...
					manage += "<a href='javascript:srvyViewMv(\"" + v.srvyId + "\", \"ADMEVLQSTN\")' class='btn basic small'><spring:message code='srvy.button.qstn' /></a>";/* 문항관리 */
				dataList.push({
					no: 				v.lineNo,
					orgnm: 				v.orgnm,
					srvyWrtTynm: 		v.srvyWrtTynm,
					srvyTrgtGbnnm: 		v.srvyTrgtGbnnm,
					srvyTtl: 			"<a href='javascript:srvyViewMv(\""+v.srvyId+"\", \"ADMEVLVIEW\")' class='header header-icon link'>" + UiComm.escapeHtml(v.srvyTtl) + "</a>",
		...
		function srvypprPreviewPopup(srvyId) {
			 dialog = UiDialog("dialog1", {
				...
				url			: "/srvy/admSrvypprPreviewPopup.do?upSrvyId="+srvyId+"&srvyId="+srvyId+"&searchValue=LCTR",
				fullscreen	: true
			});
		}
		 ...
		 * @param srvyId	설문아이디
		 */
		function lctrEvlMngPopup(srvyId) {
			dialog = UiDialog("dialog1", {
				title		: "<spring:message code='srvy.button.lctr.evl.popup' />",/* 강의평가 팝업관리 */
				width		: 900,
				height		: 500,
				url			: "/srvy/admSrvyLctrEvlMngPopup.do?srvyId="+srvyId,
				autoresize	: true
			});
		}
	</script>
                        ...
                        <div id="listDiv">
							<div class="board_top">
								...
								<div class="right-area">
									<button type="button" class="btn type1 small" id="authrtRegistBtn" onclick="srvyViewMv('', 'ADMEVLREGIST', '')"><spring:message code="srvy.button.write" /><!-- 등록 --></button>
							...
							<script>
								...
								let listTable = UiTable("list", {
									...
									columns: [
										...
										{title:"<spring:message code='srvy.label.lctr.evl.manage' />", 			field:"manage", 		headerHozAlign:"center", 	hozAlign:"center",	width:300,		minWidth:300},/* 강의평가관리 */
									]
								});
							</script>
						</div>

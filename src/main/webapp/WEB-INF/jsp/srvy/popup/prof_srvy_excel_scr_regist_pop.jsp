...
<html lang="ko" style="position: fixed; width: 100%;">
	...
	<script type="text/javascript">
		...
		function excelSampleDown() {
			...
			$("#srvyScrRegistForm").attr("target", "exampleExcelDownloadIfm");
	        $("#srvyScrRegistForm").attr("action", "/srvy/profSrvyScrRegistSampleExcelDown.do");
	        $("#srvyScrRegistForm").submit();
		}
	...
	<form id="srvyScrRegistForm" name="srvyScrRegistForm" method="POST">

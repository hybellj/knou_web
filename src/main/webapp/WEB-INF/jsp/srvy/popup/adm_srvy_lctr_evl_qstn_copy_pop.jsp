...
<html lang="ko" style="position: fixed; width: 100%;">
	...
	<script type="text/javascript">
		...
		function srvyLctrEvlListSelect() {
			...
			$.ajax({
		        url			: "/srvy/admRegistSrvyLctrEvlListAjax.do",
		        type		: "POST",
		        ...
		        success		: function (data) {
		            if (data.result > 0) {
		        		...
		        		let html = "<option value=''><spring:message code='srvy.label.select.lctr.evl.srvyppr' /></option>";/* 강의평가지 선택 */
		...
		function copyQstnChk() {
			...
			if($("#srvyId").val() == "") {
				UiComm.showMessage("<spring:message code='srvy.alert.select.lctr.evl.srvyppr' />", "info");/* 강의평가지를 선택하세요. */
				return false;
			}
        	...
        	<table class="table-type2">
	        	...
	        	<tbody>
	        		...
	        		<tr>
	        			...
	        			<td class="t_left">
	        				<select class="form-select width-100per" id="orgId" onchange="selectOption.smstrChrt()" disabled="true">
	        		...
	        		<tr>
	        			<th><label for="srvyId"><spring:message code="srvy.label.lctr.evl.srvyppr" /><!-- 강의평가지 --></label></th>
	        			<td class="t_left">
	        				<select class="form-select width-100per" id="srvyId" onchange="srvypprListSelect()">
		                        <option value=""><spring:message code="srvy.label.select.lctr.evl.srvyppr" /><!-- 강의평가지 선택 --></option>
		                    </select>
	        			</td>
	        		</tr>
	        		<tr>

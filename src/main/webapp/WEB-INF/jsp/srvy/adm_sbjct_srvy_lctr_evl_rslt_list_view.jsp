		...
		function srvyLctrEvlRsltListSelect(pageNo) {
			...
			$.ajax({
                ...
                success		: function(data) {
                    if (data.result > 0) {
    	            	var dataList = createListHTML(data.returnList);	// 목록 HTML 생성
			...
			if(srvyList.length == 0) {
				...
				srvyList.forEach(function(v,i) {
					...
					dataList.push({
						...
						sbjctCnt: 			v.sbjctCnt,
						manage: 			"<a href='javascript:srvyViewMv(\"" + v.srvyId + "\", \"ADMSBJCTEVLRSLT\")' class='btn basic small'><spring:message code='srvy.button.evl.result' /></a>"/* 평가결과 */
					});
				});
			}
							...
							<script>
								...
								let listTable = UiTable("list", {
									...
									columns: [
										...
										{title:"<spring:message code='srvy.label.ptcp.status' />", 				field:"manage", 		headerHozAlign:"center", 	hozAlign:"center",	width:150,		minWidth:150},/* 참여현황 */
									]
								});
							</script>
						</div>

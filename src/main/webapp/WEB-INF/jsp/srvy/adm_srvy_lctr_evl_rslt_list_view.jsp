...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			selectOption.smstrChrt()
		    .then(() => srvyLctrEvlRsltListSelect(PAGE_INDEX))
		    .catch(() => {});
		});
		...
		function createListHTML(list) {
			...
			list.forEach(function(v,i) {
				...
				dataList.push({
					...
					sbjctCnt: 			v.sbjctCnt,
					manage: 			"<a href='javascript:srvyViewMv(\"" + v.srvyId + "\", \"ADMEVLRSLT\")' class='btn basic small'><spring:message code='srvy.button.evl.result' /></a>"/* 평가결과 */
				});
			});
                        ...
                        <div class="search-typeB">
                            ...
                            <div class="item">
                                ...
                                <div class="itemList">
                                    ...
                                    <select class="form-select wide" id="smstrChrtId" onchange="srvyLctrEvlRsltListSelect(1)">
                                    </select>
                                </div>
                            </div>
                            <div class="item">
                            ...
                            <div class="button-area">
                                <button type="button" class="btn search" onclick="srvyLctrEvlRsltListSelect(1)"><spring:message code="srvy.button.search" /><!-- 검색 --></button>
                            </div>
                        </div>
							...
							<script>
								...
								let listTable = UiTable("list", {
									...
									columns: [
										...
										{title:"<spring:message code='srvy.button.lctr.evl.result.view' />", 	field:"manage", 		headerHozAlign:"center", 	hozAlign:"center",	width:150,		minWidth:150},/* 강의평가 결과보기 */
									]
								});
							</script>
						</div>

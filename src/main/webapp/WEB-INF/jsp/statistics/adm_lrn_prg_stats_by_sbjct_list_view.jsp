            ...
            <div id="content" class="content-wrap common">
                <div class="admin_sub">
                    ...
                    <div class="sub-content">
                        ...
                        <div class="search-typeA">
                            ...
                            <div class="item">
                                ...
                                <div class="itemList">
                                    ...
                                    <select class="form-select wide" id="sbjctOfrngId">
                            ...
                            <div class="item">
                                ...
                                <div class="itemList">
                                    <input type="text" id="searchValue" name="searchValue" class="form-control w350" value="" placeholder="과목/과목코드 입력" autocomplete="off"/>
                                </div>
                            </div>
                        ...
                        <div class="board_top">
                            <h3 class="board-title"><spring:message code="common.label.learn.progress.statistics.sbjct"/></h3><%--과목별 학습진도현황--%>
                            ...
                            $(function () {
                                ...
                                sbjctListTable = UiTable("sbjctList", {
                                    ...
                                    columns: [
                                        ...
                                        {title: "<spring:message code="common.label.decls.no" />",  field: "dvclasNo", headerHozAlign: "center", hozAlign: "center", width: 40, minWidth: 40},
                                        ...
                                        {title: "<spring:message code="common.label.learn.ratio.progress" />",  field: "lrnPrgrt", headerHozAlign: "center", hozAlign: "center", width: 70, minWidth: 70},
                                        {
                                            ...
                                            columns: [
                                                ...
                                                {title:"<spring:message code='dashboard.cor.asmnt'/>", field:"asmtPtcprt",   headerHozAlign:"center",  hozAlign:"center", width:65, minWidth: 65}, // 과제
                                                {title:"<spring:message code='dashboard.cor.quiz'/>", field:"quizPtcprt",   headerHozAlign:"center",  hozAlign:"center", width:65, minWidth: 65}, // 퀴즈
                                                {title:"<spring:message code='dashboard.cor.resch'/>", field:"srvyPtcprt",   headerHozAlign:"center",  hozAlign:"center", width:65, minWidth: 65}, // 설문
                                                {title:"<spring:message code='dashboard.cor.forum'/>", field:"dscsPtcprt",   headerHozAlign:"center",  hozAlign:"center", width:65, minWidth: 65}, // 토론
                                                {title:"<spring:message code='dashboard.seminar'/>", field:"smnrPtcprt",   headerHozAlign:"center",  hozAlign:"center", width:65, minWidth: 65}, // 세미나
                                                {title:"<spring:message code='dashboard.cor.exam'/>", field:"examPtcprt",   headerHozAlign:"center",  hozAlign:"center", width:65, minWidth: 65}, // 수시시험
                                            ]
                                        }
                                    ],
                                    pageFunc: listPaging,

				...
				<div id="info-item-box">
                	<h2 class="page-title flex-item">
					    ...
					    <div class="ui breadcrumb small">
					        <small class="section">학습자별 학습활동 통계</small>
					    </div>
					</h2>
				</div>
					...
					<div class="ui form">
						<div class="option-content gap4">
							<div class="ui pointing secondary tabmenu menu">
								<a class="item pt0 active" data-tab="1" onclick="changeTab('1')">과목별</a>
								<a class="item pt0" data-tab="2" onclick="changeTab('2')">전체누계</a>
							</div>
						</div>
						<!-- 탭 콘텐츠 -->
								...
								<table class="tBasic" data-sorting="false" data-paging="false" data-empty="<spring:message code='common.nodata.msg' />" id="table2"><!-- 등록된 내용이 없습니다. -->
									<thead class="sticky top0">
										<tr>
											...
											<th class="tc p_w20"><spring:message code="common.name" /><!-- 이름 --></th>
											<th class="tc p_w10"><spring:message code="common.crs.cd" /><!-- 학수번호 --></th>	
											<th class="tc p_w10">출제횟수</th>
											<th class="tc p_w10">제출(응시)횟수</th>
											<th class="tc p_w10">평균 마감일 대비<br/>제출(응시)일</th>
											<th class="tc p_w10">제출(응시)율</th>
											<th class="tc p_w10">평균점수</th>
										</tr>
									</thead>
									<tbody id="list2">
									</tbody>

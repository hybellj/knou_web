...
<html lang="ko" style="position: fixed; width: 100%;">
	...
	<script type="text/javascript">
		...
		function uploadExcelForum(fileObj, copyFile) {
			...
			var url = "/forum/forumLect/uploadForumScoreExcel.do";
			var data = {
				"forumCd"    	  : "${vo.forumCd}"
		...
		function sampleExcelDown() {
			...
			$("#forumUploadForm").attr("action", "/forum/forumLect/forumScoreSampleDownload.do");
	...
	<body class="modal-page <%=SessionInfo.getThemeMode(request)%>">
        <div id="wrap">
        	...
        	<button class="ui basic button mb10" onclick="sampleExcelDown()"><spring:message code="forum.button.excel.sample.down" /></button><!-- 엑셀 샘플 다운로드 -->
            ...
            <div class="bottom-content mt50">
                <button class="ui blue button" onclick="saveConfirm()"><spring:message code="forum.button.reg" /></button><!-- 등록 -->

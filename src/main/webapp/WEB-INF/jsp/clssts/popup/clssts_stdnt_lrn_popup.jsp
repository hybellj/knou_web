...
<div id="wrap">
    ...
    <div class="board_top class">
        <h3 class="board-title" id="popSbjctNm"><spring:message code="cls.label.subject.name"/></h3><%--과목명--%>
    ...
    <div class="sub-box">
        ...
        <div class="user-wrap mb30">
            ...
            <div class="table_list">
                <ul class="list">
                    <li class="head"><label><spring:message code="cls.label.org"/></label></li><%--기관--%>
                    <li id="infoOrg">-</li>
                </ul>
                <ul class="list">
                    <li class="head"><label><spring:message code="common.name"/></label></li><%--이름--%>
                    <li id="infoNm">-</li>
                </ul>
                <ul class="list">
                    <li class="head"><label><spring:message code="cls.label.student.no"/></label></li><%--학번--%>
                    <li id="infoStdntNo">-</li>
                </ul>
                <ul class="list">
                    <li class="head"><label><spring:message code="common.id"/></label></li><%--아이디--%>
                    <li id="infoUserId">-</li>
                </ul>
                <ul class="list">
                    <li class="head"><label><spring:message code="cls.label.mobile.number"/></label></li><%--휴대폰번호--%>
                    <li id="infoMobile">-</li>
                </ul>
                <ul class="list">
                    <li class="head"><label><spring:message code="cls.label.user.email"/></label></li><%--사용 이메일--%>
                    <li id="infoEmail">-</li>
                </ul>
            </div>
        </div>
    ...
    <div class="sub-box">
        <div class="board_top">
            <h3 class="board-title"><spring:message code="cls.label.learning.status"/></h3><%--학습 현황--%>
            <div class="right-area">
        ...
        <div class="table-wrap">
            <table class="table-type1">
                ...
                <tr>
                    ...
                    <th><spring:message code="cls.label.attendance.status"/></th><%--출석/지각/결석--%>
                </tr>
                </thead>
                <tbody>
                <tr>
                    ...
                    <c:forEach begin="1" end="${wkCnt}" var="w">
                        <td class="t_center" data-th="${w}<spring:message code='common.week'/>" id="wkSts${w}">-</td><%--주차--%>
                    </c:forEach>
                    <td class="t_center" data-th="<spring:message code='cls.label.attendance.status'/>" id="wkSummary">-</td><%--출석/지각/결석--%>
                </tr>
                </tbody>
            </table>
        </div>
...
<script type="text/javascript">
    ...
    function loadSubjectName() {
        ajaxCall(CTX + "/clssts/selectClsStsDetail.do", { sbjctId: sbjctId }, function (res) {
                if (res && res.result === 1 && res.returnVO) {
                    ...
                    $("#chartPeriod").text(yyyy + "." + mm + ".01 ~ " + yyyy + "." + mm + "." +
    ...
    function loadWklyData() {
        ajaxCall(CTX + "/clssts/selectClsStsStdntWeeklyInfo.do", {
                sbjctId: sbjctId,
                userId: userId
            },
            function (res) {
    ...
    function loadElemData() {
        ajaxCall(CTX + "/clssts/selectClsStsElemStats.do", { sbjctId: sbjctId, userId: userId }, function (res) {
    ...
    function loadChart() {
        ajaxCall(CTX + "/clssts/selectClsStsStdntAccessChart.do", { sbjctId: sbjctId, userId: userId }, function (res) {
    ...
    function initActivityLogTable() {
        activityLogTable = UiTable("activityLogTable", {
            ...
            placeholder: '<spring:message code="common.no.data.result"/>', <%-- 조회된 데이터가 없습니다. --%>
            columns: [
                { title: '<spring:message code="common.number.no"/>', field: "lineNo", headerHozAlign: "center", hozAlign: "center", width: 90, minWidth: 90 }, <%-- 번호 --%>
                { title: '<spring:message code="cls.label.datetime"/>', field: "actDttm", headerHozAlign: "center", hozAlign: "center", width: 180, minWidth: 180 }, <%-- 일시 --%>
                { title: '<spring:message code="cls.label.activity.content"/>', field: "actConts", headerHozAlign: "center", hozAlign: "left", width: 0, minWidth: 260 }, <%-- 활동 내용 --%>
                { title: '<spring:message code="cls.label.access.device"/>', field: "deviceNm", headerHozAlign: "center", hozAlign: "center", width: 150, minWidth: 150 }, <%-- 접근장비 --%>
                { title: '<spring:message code="cls.label.ip"/>', field: "ipAddr", headerHozAlign: "center", hozAlign: "center", width: 160, minWidth: 160 } <%-- IP --%>
            ]
        });
    }
    ...
    function loadActivityLog(page) {
        ...
        ajaxCall(CTX + "/clssts/selectClsStsStdntActivityLog.do", {
                sbjctId: sbjctId,
                userId: userId,
    ...
    function downloadActExcel() {
        ...
        $form.attr("action", CTX + "/clssts/selectClsStsStdntActivityLogExcelDown.do");

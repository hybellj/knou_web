...
<head>
	...
	<script type="text/javascript">
		...
		function onChangeTerm(){
			...
			ajaxCall("/score/scoreOverall/selectScoreObjtCtgrAdmin.do", data, function(data) {
				if(data.result > 0) {
			...
			ajaxCall(url, param, function(data) {
				...
				if(data.returnList.length > 0){
					$.each(data.returnList, function(i, o){
			            ...
			            html += "    <td class='tc'>";
			            html += "        <a href=\"javascript:onObjtProcPop('" + o.objtUserId + "','" + o.crsCreCd + "');\" class='ui basic small button'><spring:message code='exam.label.qstn.item' /></a>  ";	// 보기
			            html += "    </td>";
					...
					html += "   <div class='no_content'><i class='icon-cont-none ico f170'></i><span><spring:message code='common.no.data.result' />.</span></div>";
					html += "</div>";
					html += "</td>";
					html += "</tr>";
				}
		...
		//처리하기 팝업
		function onObjtProcPop(objtUserId, crsCreCd){
    ...
    <div id="wrap" class="pusher">
            ...
            <div class="content" >
            	<div class="ui form">
					...
					<div class="ui form">
						<div class="ui segment searchArea">
							<div class="option-content">
				                ...
				                <select id="deptCd" class="ui dropdown w250 mr5" onchange="changeDeptCd()">
			                    ...
			                    <div class="ui action input search-box mr5">
			                        <input type="text" placeholder="<spring:message code="user.message.search.input.userinfo.no.dept.nm" />" name="searchValue" id="searchValue" ><!-- 학과/학번/성명 입력 -->
			                    </div>
			                </div>
			                <div class="option-content">
			    	...
			    	<div class="option-content mb10">
                   	...
                   	<table class="tBasic type2" data-sorting="true" data-paging="false" data-empty="<spring:message code="exam.common.empty" />">
					   	<thead>
					   		<tr>
				    ...
				    <div class="ui bottom attached segment mt10">
						...
						<div class="mt10">
							<b>2. <spring:message code="score.label.chage" /></b><!-- 삭제 -->
		...
		<!-- 사유보기 팝업 -->
    		...
    		<form class="ui form" id="modalObjtProcForm" name="modalObjtProcForm" method="POST" action="">
			    ...
			    <div class="modal fade" id="modalObjtProc" tabindex="-1" role="dialog" aria-labelledby="<spring:message code="score.label.answer.result" />" aria-hidden="false">
			        <div class="modal-dialog modal-lg" role="document">
			            <div class="modal-content">
			                <div class="modal-header">
			                    <button type="button" class="close" data-dismiss="modal" aria-label="<spring:message code="sys.button.close" />">
			                    ...
			                    <h4 class="modal-title"><spring:message code="score.label.answer.result" /><!-- 성적재확인 신청 처리결과 --></h4>
			                </div>
			                <div class="modal-body">

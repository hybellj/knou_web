...
<body>
	<div class="mb10">
		<div class="ui attached message flex gap4"><spring:message code="std.label.forum" /><spring:message code="std.label.lesson_cnt" /></div><!-- 토론학습요소 -->
		<div class="ui bottom attached segment">

			<c:choose>
				<c:when test="${not empty resultList}">
					<table class="table ftable mt15" data-sorting="false" data-paging="false" data-empty="<spring:message code="forum.common.data.empty" />">
						<thead>
							<tr>
								...
								<th scope="col"><spring:message code="crs.label.forum_name" /></th>
						...
						<tbody>
							<c:forEach var="item" items="${resultList}" varStatus="status">
								<tr>
									...
									<td>${item.forumEndDttm}</td>
									<td>${item.extEndDttm}</td>
									<td>${item.forumEvalCnt}/${item.forumCnt}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
				...
				<c:otherwise>
					<table class="table_nodata ftable mt15" data-sorting="false" data-paging="false" data-empty="<spring:message code="forum.common.data.empty" />" style="width:100%;">
						<thead>
							<tr>
								<th scope="col" class="w60"><spring:message code="common.number.no" /></th>
								<th scope="col"><spring:message code="review.label.crscd" /></th>
						...
						<tbody>
							<tr>
								<td colspan="7"><spring:message code="forum.common.data.empty" /></td>
							</tr>
						</tbody>
					</table>
				</c:otherwise>

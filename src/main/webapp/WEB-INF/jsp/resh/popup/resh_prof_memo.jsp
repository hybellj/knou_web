        ...
        <div id="wrap">
        	<div class="option-content">
	            ...
	            <div class="mla fcBlue">
	            	<b>${userVo.deptNm } ${userVo.userId } ${userVo.userNm } <span class="f150">${userVo.score }<spring:message code="exam.label.score.point" /></span></b><!-- 점 -->
	            </div>
        	</div>
        	<div>
        		<textarea id="profMemo" rows="10" cols="30">${userVo.profMemo }</textarea>
        	</div>

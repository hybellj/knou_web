...
<head>
    ...
    function goWrite(dscsId) {
        if (dscsId != null && dscsId != "") {
            location.href = "<c:url value='/forum2/forumLect/profDscsEditView.do' />?dscsId=" + encodeURIComponent(dscsId) + "&encParams=" + EPARAM;
        } else {
    ...
    function goDscsBbs(dscsId) {
        location.href = '/forum2/forumLect/Form/bbsManage.do?dscsId=' + encodeURIComponent(dscsId) + "&encParams=" + EPARAM;
    }

    // 토론평가
    function goDscsScore(dscsId) {
        location.href = '/forum2/forumLect/Form/scoreManage.do?dscsId=' + encodeURIComponent(dscsId) + "&encParams=" + EPARAM;
    }
                    ...
                    <div class="sub-content">
                        ...
                        <div id="forumListArea">
                            ...
                            <div id="forumList_cardForm" class="lecture_box" style="display:none">
                                ...
                                <div class="card-body">
                                    <div class="desc">
                                        <p><label class="label-title"><spring:message code='forum.label.status.join'/></label><strong>#[dscsJoinUserCnt]/#[dscsUserTotalCnt]</strong></p><%--참여현황--%>
                                        <p><label class="label-title"><spring:message code='forum.label.forum.date'/></label><strong>#[dscsSdttmEdtm]</strong></p>  <%--참여기간--%>
                                        <p><label class="label-title"><spring:message code='forum.label.score.ratio'/></label>#[scoreRate]</p>  <%--성적 반영비율--%>
                                        <p><label class="label-title"><spring:message code='forum.label.eval.status'/></label><strong>#[mrkStatus]</strong></p> <%--평가현황--%>
                                        <p><label class="label-title"><spring:message code='forum.label.score.open'/></label><strong>#[mrkOyn]</strong></p> <%--성적공개--%>
                                    </div>
                                </div>
                            </div>
                            ...
                            <script>
                                ...
                                let dscsListTable = UiTable("forumList", {
                                    ...
                                    columns: [
                                        ...
                                        {title:"<spring:message code='forum.label.forum'/>", 			field:"dscsTtl", 		headerHozAlign:"center", hozAlign:"left", 	width:0, 	minWidth:200, frozen: true},	// 토론제목
                                        ...
                                        {title:"<spring:message code='forum.label.forum.bbsCnt'/>", 	field:"dscsAtclCnt", 	headerHozAlign:"center", hozAlign:"center", width:80,	minWidth:80},	// 토론글수
                                        {title:"<spring:message code='forum.label.forum.commCnt'/>",	field:"dscsCmntCnt", 	headerHozAlign:"center", hozAlign:"center", width:80,	minWidth:80},	// 댓글수
                                        {title:"<spring:message code='forum.label.score.ratio'/>", 		field:"scoreRate", 		headerHozAlign:"center", hozAlign:"center",	width:100,	minWidth:80},	// 성적 반영비율
                                        {title:"<spring:message code='forum.label.status.join'/>", 		field:"joinCnt", 		headerHozAlign:"center", hozAlign:"center",	width:80,	minWidth:80},	// 참여현황
                                        {title:"<spring:message code='forum.label.eval.status'/>", 		field:"mrkStatus", 		headerHozAlign:"center", hozAlign:"center",	width:80,	minWidth:80},	// 평가현황
                                        {title:"<spring:message code='forum.label.score.open'/>", 		field:"mrkOyn", 		headerHozAlign:"center", hozAlign:"center",	width:80,	minWidth:80},	// 성적공개
                                        {title:"<spring:message code='forum.label.manage'/>", 		    field:"mng",    		headerHozAlign:"center", hozAlign:"center",	width:260,	minWidth:260},	// 관리
                                    ]
                                });
                            </script>
                        </div>

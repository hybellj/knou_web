...
<html lang="ko" style="position: fixed; width: 100%;">
	...
	<script type="text/javascript">
		...
		// 사용자 목록
		function listUser() {
			var url  = "/user/userMgr/knouUserList.do";
			var data = {
		...
		function passUser() {
			...
			$(top.document).find("#knouUserId").val(userId);
			$(top.document).find("#knouUserInfo").val(userNm + " ("+userId+")");
			$(top.document).find("#knouUserDelBtn").show();

...
<script>
    ...
    function selectObjctAplyCts(rowData) {
        ...
        let mrkObjctAplyId = rowData.mrkObjctAplyId;
        let param = {"mrkObjctAplyId": mrkObjctAplyId, encParams: EPARAM};
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // 신청사유
                $("#objctAplyCts").empty();
                $("#objctAplyCts").html($.parseHTML(returnVO.objctAplyCts));

                // 처리결과
                $("#objctAplySts").empty()
                $("#objctAplySts").html(returnVO.objctAplySts)

                $("#chgRsn").empty();
                $("#chgRsn").text(returnVO.chgRsn);
            },
...
<div id="wrap">
    <div>
        ...
        <div class="table_list">
            <ul class="list">
                ...
                <li id="objctAplySts" style="width: 25%;flex: none !important;"></li>
                <li class="head" style="display: none;"></li>
                <li id="chgRsn"></li>
            </ul>
        </div>
    ...
    <div class="btns">
        <button class="btn type2" onclick="window.parent.closeDialog1();"><spring:message code="exam.button.close" /></button><!-- 닫기 -->
    </div>
</div>
...
<script type="text/javascript">
    ...
    function createObjctAplyListHTML(list) {
        ...
        list.forEach(function(item, i) {
            ...
            dataList.push({
                no: lineNo,
                mrkObjctAplyId: item.mrkObjctAplyId,
                deptnm: item.deptnm,
                userId: item.userId,
                ...
                lstScr: item.lstScr,
                rank: item.rank,
                detail: `<button class="btn s_basic" data-userid="\${item.userId}" onclick="window.parent.viewObjctAplyCts(this)">보기</button>`,
            })
        });

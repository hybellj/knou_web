				...
				<div class="user-img ui dropdown mla org-user">
					...
					<div class="menu org-user">
						...
						if(!SessionInfo.isVirtualLogin(request)) {
							...
							<div class="item"><a href="/user/userHome/logout.do" title="<spring:message code='user.button.logout' />" onclick="localStorage.removeItem('USER_PHOTO_<%=SessionInfo.getUserId(request)%>')"><i class="sign-out icon"></i><spring:message code='user.button.logout' /></a></div><!-- 로그아웃 -->
							<%
						}
						%>
					</div>

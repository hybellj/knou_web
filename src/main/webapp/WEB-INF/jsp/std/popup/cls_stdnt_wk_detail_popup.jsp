...
<script type="text/javascript">
    ...
    function renderWkSummary(d, wkNo) {
        ...
        $("#lrnTimeSpan").text(inPrd + " ( 기간 후 : " + aftPrd + " )");
    ...
    function doAtndProcess() {
        var wkNo = parseInt($("#selWkNo").val(), 10);
        UiComm.showMessage(wkNo + "주차 출석 처리를 하시겠습니까?", "confirm")
            .then(function (result) {
                ...
                $.ajax({
                    ...
                    error: function () { UiComm.showMessage("오류가 발생하였습니다.", "error"); }
                });
            });
    }

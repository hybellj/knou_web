...
<head>
	...
	<script type="text/javascript">
        ...
        function bbsAtclListMove(mode) {
            ...
            document.location.href = "/bbs/" + TEMPLATE_URL + "/bbsLctrDatarmRegistView.do?encParams="+addParams+"&bbsId="+BBS_ID+"&mode="+mode;
        };
            ...
            <div id="content" class="content-wrap common">
                ...
                <div class="dashboard_sub">
                    ...
                    <div class="sub-content">
                        <div class="page-info">
                            <h4 class="sub-title">강의자료실</h4>
                            <div class="navi_bar">
                                <ul>
                                    <li><i class="xi-home-o" aria-hidden="true"></i><span class="sr-only">Home</span></li>
                                    <li>공지사항</li>
                                    <li><span class="current">강의자료실</span></li>
                                </ul>
                            </div>
                        </div>
						...
						<div id="atclListArea">
							...
							<%-- 게시글 리스트 --%>
							<div id="bbsAtclLctrDatarmList"></div>

							<%-- 게시글 리스트 카드 폼 --%>
							<div id="bbsAtclLctrDatarmList_cardForm" style="display:none">
							...
							<script>
							// 게시글 리스트 테이블
							let atclListTable = UiTable("bbsAtclLctrDatarmList", {
								lang: "ko",
								//tableMode: "list",
								//rowHeight: 30,
								//height: 400,

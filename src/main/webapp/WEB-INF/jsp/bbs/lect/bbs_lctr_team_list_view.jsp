			...
			if(atclList.length == 0) {
				...
				atclList.forEach(function(v, i) {
					...
					if(bbsCommon.isStudent() && v.bbsCd == "SECRET" && v.regNo != USER_ID) {
						var linkUrl = 'javascript:alert(' + '<spring:message code="bbs.alert.no_auth_secret" />' + ')'; // 팀 게시글 입니다.
					} else {
						var linkUrl = "/bbs/" + TEMPLATE_URL + "/bbsDscsnView.do?encParams="+EPARAM+"&addParams="+addParams;
					}

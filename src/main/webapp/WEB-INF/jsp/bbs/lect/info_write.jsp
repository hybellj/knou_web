...
<script type="text/javascript">
	...
	function save() {
		...
		// 댓글 사용여부
		$("#infoWriteForm > input[name='cmntUseYn']").val($("input[name='cmntUse']:checked").val() == "Y" ? "Y" : "N");
		// 사용여부
		...
		if(bbsId) {
			url = '/bbs/bbsLect/editInfo.do';
		} else {
			url = '/bbs/bbsLect/addInfo.do';
		}
	...
	// 목록이동
	function moveList() {
		var url = "/bbs/bbsLect/Form/infoList.do";
		var form = $("<form></form>");
                        ...
                        <div id="info-item-box">
                        	<script type="text/javascript">
								$(document).ready(function () {
									...
									if(bbsId) {
										title2 = '<spring:message code="bbs.label.bbs_edit" />'; // 게시판 수정
									} else {
										title2 = '<spring:message code="bbs.label.bbs_add" />'; // 게시판 추가
									}
				                	...
				                	<div class="ui segment">
					                	...
					                	<ul class="tbl border-top-grey">
					                		...
					                		<li>
					                			<dl>
													<dt>
														<label><spring:message code="bbs.label.form_comment_use_yn" /><!-- 댓글 사용 여부 --></label>
													</dt>
													<dd>
														<div class="fields">
															<div class="field">
					                		...
					                		<li>
					                			<dl>
													<dt>
														<label><spring:message code="bbs.label.std.view.yn" /><!-- 학생 공개 여부 --></label>
													</dt>
													<dd>
														<div class="fields">
															<div class="field">

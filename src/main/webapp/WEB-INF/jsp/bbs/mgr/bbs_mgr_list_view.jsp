...
<html lang="ko">
	...
	<script type="text/javascript">
		...
		function listPaging(pageIndex) {
			...
			var url = "/bbs/" + TEMPLATE_URL + "/bbsMngListView2.do"
			var param = {
				  encParams		: EPARAM
							...
							<div id="atclListArea">
								...
								let atclListTable = UiTable("atclList", {
									...
									columns: [
										...
										{title:"<spring:message code='bbs.label.form_title'/>", field:"bbsnm",	    headerHozAlign:"center", hozAlign:"left",	width:0,	minWidth:200, 	headerSort:true},	// 제목

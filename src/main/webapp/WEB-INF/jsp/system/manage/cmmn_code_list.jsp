...
<head>
    ...
    <script type="text/javascript">
        ...
        // ajax URL
        var upCdInsertURL = "admUpCmmnCdRegist.do"; 	//	asis 	addSysCmmnUpCd.do
        var upCdUpdateURL = "admUpCmmnCdModify.do";		// 	asis 	editSysCmmnUpCd.do
        var upCdDeleteURL = "admUpCmmnCdDelete.do";		//	asis 	removeSysCmmnUpCd
        
        var cdInsertURL   = "admCmmnCdRegist.do";		// 	asis 	addSysCmmnCd.do
        var cdUpdateURL   = "admCmmnCdModify.do";		// 	asis 	editSysCmmnCd.do
        var cdDeleteURL   = "admCmmnCdDelete.do";		//	aiss 	removeSysCmmnCd.do
        ...
        $(document).ready(function() {
            ...
            $("#searchCdnmBtn").on("click", function() {
                ...
                if (!upCd) {
                    UiComm.showMessage("상위 코드를 먼저 선택해주세요.", "warning");
                    return;
                }
                listCdPaging(1, upCd);
            });
        ...
        function listUpCdPaging(pageIndex) {
            ...
            $.ajax({
                url: "/system/manage/admUpCmmnCdListPaging.do",
                type: "POST",
                data: param,
                dataType: "json",
        ...
        function registerCode(upCd) {
            ...
            $("#cdCancelBtn").prop("disabled", false);

            // 5. 상위 코드(upCd) 설정
            $("#modifyCdArea1 #upCd").val(upCd);

            // 6. 해당 상위코드의 공통코드 목록 조회 (ajax 실행)
            listCdPaging(1, upCd);
        ...
        function saveUpCd() {
            ...
            // 유효성 검사
            if (!updtUpCd) {
                UiComm.showMessage("상위 코드를 입력해주세요.", "warning");
                $("#updtUpCd").focus();
                return;
            }
            if (!upCdnm) {
                UiComm.showMessage("상위 코드명을 입력해주세요.", "warning");
                $("#upCdnm").focus();
                return;
            }
            ...
            UiComm.showMessage(confirmMsg, "confirm").then(function(result) {
        ...
        function listCdPaging(pageIndex, upCd) {
            ...
            $.ajax({
                url: "/system/manage/admCmmnCdListPaging.do",
                type: "POST",
                data: param,
                dataType: "json",
        ...
        function saveCd() {
            ...
            // 유효성 검사
            if (!upCd) {
                UiComm.showMessage("상위코드를 선택해주세요.", "warning");
                return;
            }
            if (!cd) {
        ...
        function resetmodifyCdArea() {
            ...
            $("#cdCancelBtn").prop("disabled", true);
        ...
        <div id="content" class="content-wrap common">
            ...
            <div class="admin_sub">
                <div class="sub-content">
                    <!-- 상단 Title -->
                    <div class="page-info">
						<h2 class="page-title">공통코드관리</h2> <%-- 현재 메뉴명 --%>
                    ...
                    <div class="search-typeB">
                        ...
                        <div class = "item" id = "modifyUpCdArea">
                            <span class = "item_tit">
                                <label for = "searchUpCdInfo" class = "req">상위 코드</label>
                            </span>
                            <div class = "itemList">
                                <!-- Update 용 코드 영역 -->
                                <input class = "form-control wide" type = "text" id = "updtUpCd" placeholder = "상위 코드" disabled>
                                <!-- 기존 코드를 저장하는 영역 -->
                                <input class = "form-control wide hidden" type = "text" id = "upCd" placeholder = "상위 코드" disabled>
                                <input class = "form-control wide hidden" type = "text" id = "upCmmnCdId" placeholder = "공통 코드 ID" disabled>
                            </div> 
                            <span class = "item_tit" style="width:200px; text-align:right;">
                                <label for="searchUpCdInfo" class = "req">상위 코드명</label>
                            </span>
                            <div class = "itemList">
                                <input class = "form-control wide" type = "text" id = "upCdnm" placeholder = "상위 코드명" disabled>
                            </div> 
                        </div>
                    ...
                    <div id="cmmnUpCdListArea">
                        <div class="board_top">
                            <h3 class="board-title">상위코드</h3>
                        </div>
                        <!-- 상위코드 검색 영역 -->
                        <div class = "item">                            
                            <div class = "form-inline">
                                <input class = "form-control" type = "text" id = "searchUpCdnm" placeholder = "상위 코드명">
                        ...
                        let cmmnUpCdListTable = UiTable("cmmnUpCdList", {
                            ...
                            columns: [
                                ...
                                {title:"상위 코드명", 	field:"cdnm", 		headerHozAlign:"center", hozAlign:"left", 		width:0, 	minWidth:200},
                                {title:"상위 코드", 	field:"cd", 		headerHozAlign:"center", hozAlign:"left", 		width:0, 	minWidth:150},
                    ...
                    <div class="search-typeB">                         
                        ...
                        <div class = "item" id = "modifyCdArea1">
                            ...
                            <div class = "itemList">
                                <!-- 상위 코드 영역 -->
                                <input class = "form-control hidden" type = "text" id = "upCd" placeholder = "상위코드" disabled>
                                <!-- 코드 ID 영역 -->
                        ...
                        <div class="button-area">                            
                            ...
                            <button type = "button" id = "cdCancelBtn" 	class="btn basic" disabled>취소</button>
                        </div>
                    </div>
                    ...
                    <div id="cmmnCdListArea">
                        ...
                        <div class = "item">                            
                            <div class = "form-inline">
                                <input class = "form-control" type = "text" id = "searchCdnm" placeholder = "코드명">
                        ...
                        let cmmnCdListTable = UiTable("cmmnCdList", {
                            ...
                            columns: [
                                ...
                                {title:"상위코드명", 	field:"upCdnm", 	headerHozAlign:"center", hozAlign:"left", 		width:0, 	minWidth:150},

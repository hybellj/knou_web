...
<html lang="ko" style="position: fixed; width: 100%;">
	...
	<script type="text/javascript">
		...
		async function doAllLink() {
			...
			await doLink('LESSON_PLAN');     	// 8.강의계획서 정보를 연동
		...
		function termLinkMgrResultPop() {
			parent.$("#termLinkMgrForm").attr("target", "termLinkMgrPopIfm");
			parent.$("#termLinkMgrForm").attr("action", "/crs/termLinkMgr/termLinkMgrResultPop.do");
			parent.$("#termLinkMgrForm").submit();
		}
	</script>

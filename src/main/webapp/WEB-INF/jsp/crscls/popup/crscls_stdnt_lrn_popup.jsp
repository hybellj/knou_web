...
<script type="text/javascript">
    ...
    function loadSubjectName() {
        $.ajax({
            url: CTX + "/crscls/selectCrsClsDetail.do",
    ...
    function loadWklyData() {
        $.ajax({
            url: CTX + "/crscls/selectCrsStdntWeeklyInfo.do",
            type: "GET",
            dataType: "json",
            data: {
                sbjctId: sbjctId,
    ...
    function loadChart() {
        $.ajax({
            url: CTX + "/crscls/selectCrsStdntAccessChart.do",
            type: "GET", dataType: "json",
            data: { sbjctId: sbjctId, userId: userId },
            success: function (res) {
    ...
    function loadActivityLog(page) {
        ...
        $.ajax({
            url: CTX + "/crscls/selectCrsStdntActivityLog.do",
            type: "GET", dataType: "json",
            data: {
                sbjctId:   sbjctId,
                userId:    userId,
    ...
    function downloadActExcel() {
        ...
        $form.attr("action", CTX + "/crscls/selectCrsStdntActivityLogExcelDown.do");

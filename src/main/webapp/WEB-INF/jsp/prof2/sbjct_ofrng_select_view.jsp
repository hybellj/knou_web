...
<body class="class colorA "><!-- 컬러선택시 클래스변경 -->
    <div id="wrap" class="main">
        <!-- common header -->
        <%@ include file="../common_new/class_header.jsp" %>
        <!-- //common header -->
        ...
        <main class="common">
            ...
            <!-- gnb -->
            <%@ include file="../common_new/class_gnb_prof.jsp" %>
            <!-- //gnb -->
                                        ...
                                        <div class="user-option-wrap">
                                            ...
                                            <ul class="user_area">
                                                <li>
                                                    <div class="user-info">
                                                        <div class="user-photo">
                                                            <img src="../assets/img/common/photo_user_sample2.jpg" aria-hidden="true" alt="사진">
                                                        </div>
                                                        <div class="user-desc">
                                                            <p class="name">나방송</p>
                                                ...
                                                <li>
                                                    <div class="user-info">
                                                        <div class="user-photo">
                                                            <img src="../assets/img/common/photo_user_sample3.jpg" aria-hidden="true" alt="사진">
                                                        </div>
                                                        <div class="user-desc">
                                                            <p class="name">최남단</p>
                        ...
                        <div class="segment">
                            ...
                            <div class="box_content">
                                <ul class="dash_item_listA">
                                    ...
                                    <li>
                                        <div class="user">
                                           <span class="user_img"><img src="../assets/img/common/photo_user_sample2.jpg" aria-hidden="true" alt="사진"></span>
                                        </div>
                                        <a href="#0" class="item_txt">                                            
                        ...
                        <div class="segment">
                            ...
                            <div class="box_content">
                                <ul class="dash_item_listA">
                                    <li>
                                        <div class="user">
                                           <span class="user_img"><img src="../assets/img/common/photo_user_sample3.jpg" aria-hidden="true" alt="사진"></span>
                                        </div>
                                        <a href="#0" class="item_txt">                                            

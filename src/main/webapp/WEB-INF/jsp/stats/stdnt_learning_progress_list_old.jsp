...
<script type="text/javascript">
		...
		var SBJCT_ID        = '<c:out value="${vo.sbjctId}" />'; // const에서 var로 안전하게 변경
		var listTable; 
		var globalTotalCnt = '';
		...
		$(document).ready(function () {
			...
			// 2. 테이블 생성 직후 명시적으로 첫 데이터 호출 (tableBuilt 비동기 락 방지)
			getList(PAGE_INDEX);
	            ...
	            if (data.result > 0) {
	                ...
	                if (data.pageInfo) {
	                    ...
	                    listTable.setPageInfo({
	                        ...
	                        totalRecordCount: globalTotalCnt
	                    });
	                }
		...
		function createListHTML(list) {			 
			...
			if (list && list.length > 0) {
		        globalTotalCnt = list[0].totalCnt;
		        console.log("전체 총 건수(첫 행에서 추출):", globalTotalCnt);
		        $("#totalCntSpan").text(globalTotalCnt);		        
		        $(".lecture_status_box strong").text(globalTotalCnt + "명");
		    } else {
		        $("#totalCntSpan").text(0);
		    }
	...
	<div id="wrap" class="main">
        <main class="common">            
            ...
            <div id="content" class="content-wrap common">
                    ...
                    <div class="sub-content">
                        ...
                        <div class="lecture_status_box">
                            <div class="box_item">
                                ...
                                <div class="item_txt">
                                    <p class="desc"><i class="icon-svg-group" aria-hidden="true"></i>수강생 수 : <strong>명</strong></p>
                        ...
                        <div class="board_top">
                            <h3 class="board-title">학습진도현황</h3> [ 총 건수 : <span id="totalCntSpan"></span> 건]
                ...
                <div class="btns">
                	<button onclick="document.getElementById('loadLearnProgressPopView').style.display='none'" class="btn type1">닫기</button>
            	</div>
            </div>

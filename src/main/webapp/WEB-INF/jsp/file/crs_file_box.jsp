	...
	function listFileBoxTree() {
		...
		ajaxCall(url, data, function(data) {
        	if(data.result > 0) {
        		...
        		// 최상위 폴더 추가
        		var html = '<span class="folder cur_point" onclick="javascript:setMenuTreeItem(\'ROOT\')">자료실</span>';
			...
			<div class="content">
                ...
                <div class="ui form">
                	<div class="layout2">
                		...
                		<div class="classInfo">
                			<div class="mra">
                				<h2 class="page-title fcWhite"><spring:message code="filemgr.label.my.file.box" /><!-- 개인자료실 --></h2>
                			</div>
                			<div class="button-area">
                				<c:if test="${PROFESSOR_VIRTUAL_LOGIN_YN ne 'Y'}">
                				<a href="javascript:void(0);" class="ui bcPurpleAlpha85 fcWhite button" onclick="createFolder()"><spring:message code="filebox.button.create.foler" /><!-- 폴더생성 --></a>
								<a href="javascript:void(0);" class="ui bcTealAlpha85 fcWhite button" onclick="fileBoxUploadModal()"><spring:message code="filebox.button.upload" /><!-- 업로드 --></a>
		                        <a href="javascript:void(0);" class="ui bcDarkblueAlpha85 fcWhite button" onclick="deleteFileBox()"><spring:message code="filebox.button.del" /><!-- 삭제 --></a>
                				</c:if>
                			</div>
                		</div>
											...
											<table id="fileListTable" class="table type2 footable footable-1 breakpoint-w_lg" data-sorting="true" data-paging="false" data-empty="<spring:message code="filebox.common.empty" />">
												...
												<thead>
													<tr>
														...
														<th scope="col"><spring:message code="filebox.label.list.filenm" /><!-- 파일명 --></th>
														<th scope="col" data-breakpoints="xs"><spring:message code="filebox.label.list.createdt" /><!-- 생성일 --></th>
														<th scope="col" data-breakpoints="xs"><spring:message code="filebox.label.list.size" /><!-- 크기 --></th>

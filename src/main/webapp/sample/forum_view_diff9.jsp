...
function createForumListHTML(forumList) {
    ...
    forumList.forEach(function(v, i) {
        ...
        v.cmntList.forEach(function(rs) {
            var isReply = rs.level === 2;
            html += "      <ul" + (isReply ? " class='co_inner'" : "") + ">";
            html += "        <li>";
            html += "          <ul>";
            html += "            <li class='flex-item'>";
            html += "              <em class='mra mt0'>" + escapeHtml(rs.regNm) + "</em>";
            html += "              <em class='mt0'><code>" + formatDttm(rs.modDttm) + " | 글자수: " + rs.cmntCtsLen + "자</code></em>";
            html += "            </li>";
            html += "            <li>";
            if (isReply) {

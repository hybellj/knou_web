                ...
                <div class="content-box">
                    ...
                    <div id="tab1" class="tab_content" style="display:block;">
                        ...
                        <script type="text/template" id="comment-item-template">
                            <ul class="comment_list_item" data-field="dscsCmntId" data-role="comment-item">
                                <li>
                                    <div class="item comment-row">
                                        <div class="cmt_info">
                                            <strong class="name" data-field="rgtrNm"></strong>
                                            <span class="date" data-field="commentMeta"></span>
                                            <span data-field="regDttm" class="dpn"></span>
                                            <span data-field="cmntCtsLen" class="dpn"></span>
                                        </div>
                                        <span class="comment"><em data-role="parent-mention" class="dpn">@<span data-field="parRegNm"></span></em> <span data-field="atclCmntCts"></span></span>
                                        <span class="cmtBtnGroup">
                                            <button type="button" class="cmtWri" data-role="btn-reply">답글</button>
                                            <button type="button" class="cmtUpt" data-role="btn-edit">수정</button>
                                            <button type="button" class="cmtDel" data-role="btn-delete">삭제</button>
                                        </span>
                                        <span data-field="dscsCmntId" class="dpn"></span>
                                        <ul class="re_comment_ul" data-role="reply-container"></ul>
                                    </div>
                                </li>
                            </ul>
                        </script>

                        <script type="text/template" id="reply-item-template">
                            <ul class="co_inner" data-field="dscsCmntId" data-role="reply-item">
                                <li class="re_comment">
                                    <div class="item comment-row">
                                        <div class="cmt_info">
                                            <strong class="name" data-field="rgtrNm"></strong>
                                        ...
                                        <span class="comment"><em data-role="parent-mention">@<span data-field="parRegNm"></span></em> <span data-field="atclCmntCts"></span></span>
                                        <span class="cmtBtnGroup">
                                            <button type="button" class="cmtWri" data-role="btn-reply">답글</button>
                                            <button type="button" class="cmtUpt" data-role="btn-edit">수정</button>
                                            <button type="button" class="cmtDel" data-role="btn-delete">삭제</button>

<%@ page contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
	...
	<aside id="gnb" class="common gnb-menu expanded">
		...
		<div class="scrollarea">
			...
			<div class="user-info">
				<div class="box">
					<div class="user-photo stu">
						<!-- <img src="<%=request.getContextPath()%>/webdoc/assets/img/common/default_stu.png" aria-hidden="true" alt="사진"> -->
					</div>
			...
			<nav class="gnb">
				...
				<div class="gnb-item">
					<a href="#0" ><i class="icon-svg-exercise" aria-hidden="true"></i><span>강의계획서</span></a>
				</div>

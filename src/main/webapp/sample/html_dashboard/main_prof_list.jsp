                        ...
                        <div class="box span-2 subject">
                            <div class="box_title">
                                ...
                                <div class="btn-wrap">
                                    ...
                                    <a href="#0" class="btn_list_type on" aria-label="리스트형 보기"><i class="icon-svg-list" aria-hidden="true"></i></a><!-- 버튼 선택 on 클래스 추가 -->
                                ...
                                <div id="tab31" class="tab-content" style="display: block;">
                                    ...
                                    <ul class="lecture_list2">
                                        ...
                                        <li>
                                            <div class="card_item">
                                                <div class="item_header">
                                                    <span class="label uniD">대학원</span>
                                                    <div class="title_area">
                                                        <p class="info_detail">
                                                            <span class="info_txt">수강 50명</span>
                                                            <span class="info_txt">튜터 김하늘</span>
                                        ...
                                        <li>
                                            <div class="card_item">
                                                <div class="item_header">
                                                    <span class="label uniE">평생<br>교육</span>
                                                    <div class="title_area">
                                                        <p class="info_detail">
                                                            <span class="info_txt">수강 200명</span>
                                                            <span class="info_txt">튜터 한여름</span>
                                        ...
                                        <li>
                                            <div class="card_item">
                                                <div class="item_header">
                                                    <span class="label uniF">학위<br>과정</span>
                                                    <div class="title_area">
                                                        <p class="info_detail">
                                                            <span class="info_txt">수강 50명</span>
                                                            <span class="info_txt">튜터 김하늘</span>

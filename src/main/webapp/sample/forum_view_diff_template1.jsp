        ...
        <div class="content-box">
            ...
            <div id="tab1" class="tab_content" style="display:block;">
                ...
                <script type="text/template" id="comment-item-template">
                    <ul data-field="dscsCmntId" data-role="comment-item">
                        <li>
                            <ul data-role="reply-container">
                                <li class="flex-item"><em class="mra mt0"><span data-field="rgtrNm"></span> <code><span data-field="commentMeta"></span><span data-field="regDttm" class="dpn"></span><span data-field="cmntCtsLen" class="dpn"></span></code></em></li>
                                <li><em data-role="parent-mention" class="dpn">@<span data-field="parRegNm"></span></em> <span data-field="atclCmntCts"></span><span data-field="dscsCmntId" class="dpn"></span></li>
                            </ul>
                        </li>
                    </ul>
                </script>
                ...
                <script type="text/template" id="reply-item-template">
                    <ul class="co_inner" data-field="dscsCmntId" data-role="reply-item">
                        <li>
                            <ul data-role="reply-container">
                                <li class="flex-item"><em class="mra mt0"><span data-field="rgtrNm"></span> <code><span data-field="commentMeta"></span><span data-field="regDttm" class="dpn"></span><span data-field="cmntCtsLen" class="dpn"></span></code></em></li>
                                <li><em data-role="parent-mention">@<span data-field="parRegNm"></span></em> <span data-field="atclCmntCts"></span><span data-field="dscsCmntId" class="dpn"></span></li>
                            </ul>
                        </li>
                    </ul>
                </script>

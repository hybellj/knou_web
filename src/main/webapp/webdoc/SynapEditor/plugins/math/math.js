...
var MATH_EDITOR = {curEditor:null, dialog:null, url:"/webdoc/math/math.html"};
var pluginName = "math";
    ...
    return {
        buttonDef: {
            ...
            onClickFunc: function () {
            	...
            	MATH_EDITOR.dialog = UiDialog("mathEditor", title, "width=670,height=440,resizable=true,draggable=true,modal=true,autoresize=false");
            	MATH_EDITOR.dialog.html("<iframe frameborder='0' scrolling='auto' style='width:100%;height:98%' src=\""+MATH_EDITOR.url+"\" title='Equation'></iframe>");
            	MATH_EDITOR.dialog.open();
            }
        }
    };
};

(function () {
    var messages = {
        ...
        "message.alert.exportingDocument": "Đang chuyển đổi tài liệu...",
        "message.alert.exportingDocumentFailed": "Chuyển đổi tài liệu không thành công.",
        ...
        "message.alert.invalidFileNameChars": "Tên tệp không được bắt đầu bằng dấu cách hoặc dấu chấm.<br>Các ký tự sau không được phép: &lt; &gt; : &quot; / &#92; | ? *",
        "message.alert.invalidFileNameLength": "Vui lòng nhập tên tệp tin (không quá 255 ký tự, bao gồm cả phần mở rộng).",
        ...
        "message.error.exportApiNotConfigured": "API xuất chưa được cấu hình.",
        "message.error.exportRequiresDocModelParser": "Cần có mô-đun phân tích tài liệu (SEDocModelParser) để sử dụng tính năng xuất.",
        ...
        "message.label.landscape": "A4 Ngang",
        ...
        "message.template.pageOrientation": "Hướng giấy",

(function () {
    var messages = {
        ...
        "message.alert.exportingDocument": "ドキュメントを変換しています...",
        "message.alert.exportingDocumentFailed": "ドキュメントの変換に失敗しました。",
        ...
        "message.alert.invalidFileNameChars": "ファイル名はスペースまたはピリオドで始めることはできません。<br>次の文字は使用できません: &lt; &gt; : &quot; / &#92; | ? *",
        "message.alert.invalidFileNameLength": "拡張子を含めて255文字以内でファイル名を入力してください。",
        ...
        "message.error.exportApiNotConfigured": "エクスポートAPIが設定されていません。",
        "message.error.exportRequiresDocModelParser": "エクスポート機能を使用するには、ドキュメント解析モジュール（SEDocModelParser）が必要です。",
        ...
        "message.template.pageOrientation": "ページの向き",

...
// 라이센스 파일
let synapEditorLicensePath = (new URL(document.currentScript.src)).pathname;
synapEditorLicensePath = synapEditorLicensePath.substring(0, synapEditorLicensePath.lastIndexOf('/') + 1) + "license.json";
...
var synapEditorConfig = {
     ...
     */
    'editor.license': synapEditorLicensePath,
    ...
    'editor.toolbar': [
        ...
        'specialCharacter', 'emoji', 'shapeEditor', '|',
        'math', '|',
    ...
    */
    ...
    'editor.defaultStyle': {
        ...
        'Paragraph': 'line-height: 1.4; margin: 0;'
    },
    ...
    */
     ...
     */
    'editor.upload.video.extensions': ['mp4', 'ogg', 'webm', 'mp3'],

 ...
 * 테이블: TB_LMS_ORG
 */
public class OrgVO extends DefaultVO implements Serializable{
...
//    private String orgnm;           // ORGNM (기관명)
    ...
    private String orgTycdnm;       // 기관 유형코드명
    ...
    private String cprghtCts;        // CPRGHT_CTS (카피라이트문구)
...
//    public void setOrgnm(String orgnm) { this.orgnm = orgnm; }
    ...
    public String getCprghtCts() { return cprghtCts; }
    public void setCprghtCts(String cprghtCts) { this.cprghtCts = cprghtCts; }

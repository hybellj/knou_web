package knou.lms.bbs2.vo;

/*
 *	게시판2게시글VO
 */
public class Bbs2AtclVO {
	
	private String atclId;              // ATCL_ID
    private String bbsId;               // BBS_ID
    private String userId;              // USER_ID
    private String upAtclId;            // UP_ATCL_ID
    private String dvclasRegAtclId;      // DVCLAS_REG_ATCL_ID
    private String atclTtl;             // ATCL_TTL
    private String atclCts;             // ATCL_CTS
    private String atclHashTagCts;       // ATCL_HASH_TAG_CTS
    private int atclLv;                 // ATCL_LV
    private int atclSeqno;              // ATCL_SEQNO
    private int fvrtCnt;                // FVRT_CNT
    private int inqCnt;                 // INQ_CNT
    private String refCmntId;            // REF_CMNT_ID
    private String thmbFileId;           // THMB_FILE_ID
    private String procStscd;            // PROC_STSCD
    private String hdrTycd;              // HDR_TYCD
    private String athrId;               // ATHR_ID
    private String dscsnProfId;          // DSCSN_PROF_ID

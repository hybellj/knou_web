...
public interface ScoreConfDAO {
    ...
    public int editConvertUseYn(ScoreConfVO vo) throws Exception;
    ...
    public int editRelativeUseYn(ScoreConfVO vo) throws Exception;
    ...
    // public void editAbsentScoreClass(ScoreConfVO vo) throws Exception;
    ...
    // 등록된 등급 조회
	public List<ScoreConfVO> selectCRelCdLList(ScoreConfVO vo);
	public List<ScoreConfVO> selectGRelCdLList(ScoreConfVO vo);

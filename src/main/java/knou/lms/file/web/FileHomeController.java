...
public class FileHomeController extends ControllerBase {
     ...
     * @throws Exception
     ******************************************************/
    @RequestMapping(value="/bbsZipFileDown.do")
    @ResponseBody
    public void bbsZipFileDown(FileVO vo, HttpServletRequest request, HttpServletResponse response) throws Exception {
        String fileNamePattern = "[:\\\\/%*?:|\"<>]";
        ...
        if(ValidationUtils.isNotEmpty(repoCd) || ValidationUtils.isNotEmpty(fileBindDataSn)) {
            ...
            sysFileService.bbsZipFileDown(fileNm, fileList, request, response);
        }
    }
}
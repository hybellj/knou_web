...
public interface QbnkCtgrDAO {
	 ...
	 * @throws Exception
	 */
	public List<EgovMap> profQbnkCtgrAllList(QbnkCtgrVO vo) throws Exception;
	 ...
	 * @throws Exception
	 */
	public EgovMap profQbnkSbjctSelect(@Param("sbjctId") String sbjctId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public QbnkCtgrVO qbnkCtgrSelect(@Param("qbnkCtgrId") String qbnkCtgrId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public EgovMap qbnkCtgrUseCntSelect(@Param("qbnkCtgrId") String qbnkCtgrId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void qbnkCtgrSeqnoModify(QbnkCtgrVO vo) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<EgovMap> qbnkSearchSbjctList(@Param("userId") String userId) throws Exception;

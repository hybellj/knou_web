...
public class MsgEmlVO extends DefaultVO {
    ...
    private String msgEmlSndngId;
    private String replyMsgEmlSndngId;
    private String bfrMsgEmlSndngId;
    ...
    private String sndngrEml;
    private String sndngRetrySeqno;
    private String sndngRsltCd;
    private String lnkClckDttm;
    private String bnceDttm;
    ...
    public String getMsgEmlSndngId() {
        return msgEmlSndngId;
    }

    public void setMsgEmlSndngId(String msgEmlSndngId) {
        this.msgEmlSndngId = msgEmlSndngId;
    }

    public String getReplyMsgEmlSndngId() {
        return replyMsgEmlSndngId;
    }

    public void setReplyMsgEmlSndngId(String replyMsgEmlSndngId) {
        this.replyMsgEmlSndngId = replyMsgEmlSndngId;
    }

    public String getBfrMsgEmlSndngId() {
        return bfrMsgEmlSndngId;
    }

    public void setBfrMsgEmlSndngId(String bfrMsgEmlSndngId) {
        this.bfrMsgEmlSndngId = bfrMsgEmlSndngId;
    }
    ...
    public String getSndngrEml() {
        return sndngrEml;
    }

    public void setSndngrEml(String sndngrEml) {
        this.sndngrEml = sndngrEml;
    }
    ...
    public String getLnkClckDttm() {
        return lnkClckDttm;
    }

    public void setLnkClckDttm(String lnkClckDttm) {
        this.lnkClckDttm = lnkClckDttm;
    }

    public String getBnceDttm() {
        return bnceDttm;
    }

    public void setBnceDttm(String bnceDttm) {
        this.bnceDttm = bnceDttm;
    }

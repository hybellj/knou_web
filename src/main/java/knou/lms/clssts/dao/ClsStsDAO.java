...
public interface ClsStsDAO {
     ...
     * @return List<ClsVO>
     ******************************************************/
    public List<ClsVO> selectClsListPaging(ClsVO vo);
     ...
     ******************************************************/
    public List<ClsStdntVO> selectClsStdntListPaging(ClsStdntVO vo);
     ...
     * @return int
     ******************************************************/
    public int selectClsElemStatsListCnt(ClsElemStatsVO vo);
     ...
     ******************************************************/
    public List<ClsElemStatsVO> selectClsElemStatsListPaging(ClsElemStatsVO vo);
     ...
     * @return int
     ******************************************************/
    public int selectStdntActivityLogCnt(ClsActivityLogVO vo);
     ...
     ******************************************************/
    public List<ClsActivityLogVO> selectStdntActivityLogPaging(ClsActivityLogVO vo);

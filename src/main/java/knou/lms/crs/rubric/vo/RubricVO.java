package knou.lms.crs.rubric.vo;
...
public class RubricVO extends DefaultVO {
    ...
    private String rubricQstnTtl;       // 루브릭 문항 제목
    private int rubricQstnSeqno;     // 루브릭 문항 순번
    private int evlrt;               // 평가비율
    ...
    private List<RubricVO> rubricQstns;
    private String readOnlyYn;          // 조회 전용 여부
    ...
    public List<RubricVO> getRubricQstns() {
        return rubricQstns;
    }

    public void setRubricQstns(List<RubricVO> rubricQstns) {

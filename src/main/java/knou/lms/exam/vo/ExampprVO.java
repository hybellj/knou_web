...
public class ExampprVO extends DefaultVO {
	...
	private String  qstnVwitmDsplySeq;	// 문항보기항목화면표시순서
	...
	public String getQstnVwitmDsplySeq() {
		return qstnVwitmDsplySeq;
	}
	...
	public void setQstnVwitmDsplySeq(String qstnVwitmDsplySeq) {
		this.qstnVwitmDsplySeq = qstnVwitmDsplySeq;
	}

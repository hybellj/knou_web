...
@Mapper("examQbankCtgrDAO")
public interface ExamQbankCtgrDAO {
     ...
     * @throws Exception
     ******************************************************/
    public List<ExamQbankCtgrVO> listPaging(ExamQbankCtgrVO vo) throws Exception;
    ...
    /*****************************************************
     * TODO 문제은행 분류코드 순서 수정
     * @param ExamQbankCtgrVO
     * @return void
     * @throws Exception
     ******************************************************/
    public void updateQbankCtgrOdr(ExamQbankCtgrVO vo) throws Exception;

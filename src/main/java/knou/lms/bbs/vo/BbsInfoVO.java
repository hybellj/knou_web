...
/**
 * TB_LMS_BBS (게시판 / 구 TB_HOME_BBS_INFO) -- 테이블명 변경으로 삭제 예정- BbsVO 클래스로변경
 * @author 김도희
 *
 */
public class BbsInfoVO extends DefaultVO {
    private static final long serialVersionUID = -8061054982843918999L;

    //
    private String bbsId;			// 구 게시판 아이디
    private String sbjctId;			// 과목 아이디 (구 crsCreCd)
